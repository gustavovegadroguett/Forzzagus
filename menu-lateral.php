...
<div id="content">
        ...
        <div id="menu" class="nav">
            ...
            <ul>
                ...
                <li><a href="#"><i class="fas fa-clipboard-list"></i>&nbsp;&nbsp;Lista de Producto</a></li>
                <li><a href="#"><i class="fas fa-cubes"></i>&nbsp;&nbsp;Tipo de Productos</a></li>
                <br>
               
                <li><h4>Categorías</h4></li>
                <hr>
                <br>
                <li><a href="./subcate/agregarsubcate.php"><i class="fas fa-file-upload"></i>&nbsp;&nbsp;Nueva Categoría</a></li>
                <li><a href="./subir_marca.php"><i class="fas fa-file-upload"></i>&nbsp;&nbsp;Nueva Marca</a></li>
                <li><a href="#"><i class="fas fa-folder-plus"></i>&nbsp;&nbsp;Sub Categorías</a></li>
                <br>
               
                <li><h4>Ofertas</h4></li>
                <hr>
                <br>
                <li><a href="#"><i class="fas fa-file-invoice-dollar"></i>&nbsp;&nbsp;Nueva Oferta</a></li>
