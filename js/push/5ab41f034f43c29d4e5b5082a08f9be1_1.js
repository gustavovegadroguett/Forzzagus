...
var oSpPOptions = {
    sAppUrl: "https://www.templatemonster.com",
    sAppUrlShow: "https://www.templatemonster.com",
    sOrigUrl: "https://www.templatemonster.com",
    sOrigFFUrl: "https://www.templatemonster.com",
    ...
    bAutoSubscribe: true,
    sAppKey: "5ab41f034f43c29d4e5b5082a08f9be1",
    prompt_settings: "",
    prompt_title: "",
    prompt_text: "",
    prompt_description: "-",
    ...
    bMobileEnabled: true,
    show_splogo: "0",
    spdomain_website: "https://sendpulse.com/ru/webpush-powered-by-sendpulse?sn=dGVtcGxhdGVtb25zdGVyLmNvbQ%3D%3D",
    aPoweredbySendpulse: {
...
function oSendpulsePush() {
    var s = oSpPOptions.sAppUrl,
        ...
        r = oSpPOptions.gcmServer,
        p = oSpPOptions.bAutoSubscribe,
        h = oSpPOptions.sAppKey,
        j = oSpPOptions.prompt_settings,
        U = oSpPOptions.prompt_title,
        V = oSpPOptions.prompt_text,
        a = oSpPOptions.prompt_description,
        l = oSpPOptions.currentDB,
        g = oSpPOptions.parentEvent,
        f = oSpPOptions.initedPage,
        v = oSpPOptions.parentVariables,
        w = oSpPOptions.pushedVariables,
        D = oSpPOptions.pushedInterval,
        y = oSpPOptions.sFirefoxServer,
        A = oSpPOptions.sFirefoxServer2,
        O = oSpPOptions.bWasPrompt,
        x = oSpPOptions.startTime,
        T = oSpPOptions.isParentAutoSubscribe,
        I = oSpPOptions.bSentToServer,
        M = oSpPOptions.bSentStatOpened,
        k = oSpPOptions.bSentStatPermission,
        C = oSpPOptions.bMobileEnabled,
        H = oSpPOptions.show_splogo,
        B = oSpPOptions.spdomain_website,
        z = oSpPOptions.aPoweredbySendpulse,
        e = oSpPOptions.iPromptDelay,
        E = oSpPOptions.visitNumber,
        _ = new Date,
        R = new Date(_.getFullYear(), _.getMonth() + 1, _.getDate()).getTime();
    R = _.getDate() + "" + R, this.start = function () {
        ...
        if (b = oSpP.detectOs(), !C && ("iOS" == b || "Android" == b)) return oSpP.log("Application disabled for your device"), !1;
        if (oSpP.detectHttps(), m = oSpP.detectBrowser(), S = m.name.toLowerCase(), ("iOS" == b || "Android" == b) && "chrome" == S && parseFloat(m.version) < 42) return oSpP.log("Application disabled for your browser version"), !1;
        if ("firefox" == S && parseFloat(m.version) < 44) return oSpP.log("Application can not work with Firefox browser version less then 44"), !1;
        if ("opera" == S && parseFloat(m.version) < 43) return oSpP.log("Application can not work with Opera browser version less then 43"), !1;
        if ("firefox" == S && (c = n), d) {
            T && (k = M = !0);
            var e = setInterval(function () {
                I && M && k && (oSpP.sendToParent("closeme"), clearInterval(e))
            }, 50)
        }
        if (i)
            if (p) oSpP.startDelayedSubscription(function () {
                oSpP.startSubscription(), "safari" != S && "chrome" != S && "firefox" != S && "opera" != S || oSpP.showhelpPromptText(), oSpP.isServiceWorkerChromeSupported() && oSpP.showPushLabel()
            });
            else {
            ...
            if (oSpP.detectOrigin(e.origin))
                if ("init" == e.data)(g = e).source.postMessage("initend", g.origin);
                else if (0 === e.data.indexOf("initpage")) {
                2 == (t = e.data.split("|")).length && (f = t[1], localStorage.setItem("source_url", f))
        ...
        switch (S) {
            ...
            case "opera":
                navigator.serviceWorker.getRegistrations().then(function (e) {
                    if (e)
                        for (var t = 0; t < e.length; t++) e[t].active && -1 != e[t].active.scriptURL.indexOf("sp-push-worker.js") && e[t].unregister()
                }), oSpP.isServiceWorkerChromeSupported() && (oSpP.log("ASK for Permission"), x = Date.now(), Notification.requestPermission(oSpP.doActionsWithPermissions), oSpP.registerChrome())
        }
        ...
        i = 0 === window.location.href.indexOf("https://")
        ...
        var t = Date.now() - x;
        switch (O = !(t < 50), oSpP.log("[DD] Permissions: " + e), oSpP.log("[DD] Time diff: " + t), e) {
            case "granted":
                switch (T || O && oSpP.getDbValue("SPIDs", "PromptShowed", function (e) {
                ...
                break;
            case "default":
                T || O && oSpP.getDbValue("SPIDs", "PromptShowed", function (e) {
        ...
        p ? "default" == e ? oSpP.closePromptHelpText(!1) : oSpP.closePromptHelpText(!0) : "default" == e ? oSpP.closeCustomPrompt(!1) : oSpP.closeCustomPrompt(!0), oSpP.closePushLabel()
        ...
        oSpP.log("[DD] Permissions: " + e.permission), "default" === e.permission ? (p ? oSpP.closePromptHelpText(!1) : oSpP.closeCustomPrompt(!1), O = !0, oSpP.getDbValue("SPIDs", "PromptShowed", function (e) {
            ...
            appkey: h
        }, oSpP.checkSafariPermission)) : "denied" === e.permission ? (p ? oSpP.closePromptHelpText(!0) : oSpP.closeCustomPrompt(!0), O && oSpP.sendPromptStat("prompt_denied")) : "granted" === e.permission && (oSpP.uns(), p ? oSpP.closePromptHelpText(!0) : oSpP.closeCustomPrompt(!0), O && oSpP.sendPromptStat("prompt_granted"), oSpP.subscribe()), oSpP.closePushLabel()
        ...
        switch (S) {
            ...
            case "opera":
                ...
                return ~t.indexOf(r) ? t.split(r)[1] : ~t.indexOf(oSpPOptions.fcmServer + "send/") ? t.split(oSpPOptions.fcmServer + "send/")[1] : t;
            case "firefox":
                return ~(t = e.endpoint).indexOf(y) ? t.split(y)[1] : ~t.indexOf(A) ? t.split(A)[1] : t
        }
    }, this.fetchFcmToken = function (n, i, r) {
        return new Promise(function (t, o) {
            var e = oSpPOptions.fcmServer + "send/" + encodeURIComponent(n),
                s = "authorized_entity=" + oSpPOptions.sPushSenderID;
            return s += "&endpoint=" + e, s += "&encryption_key=" + encodeURIComponent(i), s += "&encryption_auth=" + encodeURIComponent(r), fetch(oSpPOptions.fcmServer + "connect/subscribe", {
                method: "post",
                headers: {
            ...
            case "opera":
                navigator.serviceWorker.ready.then(function (o) {
                    o.pushManager.subscribe({
                        ...
                        oSpP.checkLocalSubsctoption(t, s, i), d && oSpP.sendToParent(t)
                    }).catch(function (e) {
                        11 == e.code && navigator.serviceWorker.getRegistrations().then(function (e) {
                            for (var t = 0; t < e.length; t++) - 1 == e[t].active.scriptURL.indexOf("OneSignalSDKWorker.js") && -1 == e[t].active.scriptURL.indexOf("pushcrew-sw.js") && -1 == e[t].active.scriptURL.indexOf("push-worker.js") && -1 == e[t].active.scriptURL.indexOf("sw.js") && -1 == e[t].active.scriptURL.indexOf("service-worker.js") && -1 == e[t].active.scriptURL.indexOf("pushwoosh-service-worker.js") && -1 == e[t].active.scriptURL.indexOf("serviceworker.js") && -1 == e[t].active.scriptURL.indexOf("sp-push-worker-fb.js") || e[t].unregister().then(function () {
        ...
        d && "subscribe" == t && (i.onreadystatechange = function () {
            4 == i.readyState && 200 == i.status && (I = !0)
        }), i.open("POST", P, !0), i.setRequestHeader("Content-Type", "application/json"), void 0 === o && ((o = {}).uname = oSpP.checkCookie("lgn"), o.os = oSpP.detectOs()), void 0 === s && (s = ""), o.variables = d ? v : oSpP.getUserVariables();
        var r, p = -(new Date).getTimezoneOffset() / 60;
        if (o.timezoneoffset = p, f) r = f;
        else {
            var a = localStorage.getItem("source_url");
            r = a || window.location.href
        }
        var l = oSpPOptions.sSubscriptionPrefix;
        switch (S) {
            case "safari":
            case "firefox":
                l = ""
        ...
        if (null === g) var t = setInterval(function () {
            null !== g && (g.source.postMessage(e, g.origin), clearInterval(t))
        }, 100);
        else g.source.postMessage(e, g.origin)
        ...
        o.open("POST", P, !0), o.setRequestHeader("Content-Type", "application/json");
        var s = {
            action: "subscription",
            subscriptionId: e,
            subscription_type: t,
        ...
        if (t.rel = "stylesheet", t.type = "text/css", t.href = "https://cdn.sendpulse.com/dist/css/push/sendpulse-prompt.min.css?v=" + R, t.media = "all", e.appendChild(t), 0 <= a.length && "-" != a) {
            var o = document.createElement("div");
            o.setAttribute("class", "sendpulse-backdrop-info"), o.setAttribute("style", "display:none;");
            var s = document.createElement("div");
            s.setAttribute("class", "backdrop-close"), s.innerHTML += "<big>×</big><br><small>ESC</small>", s.setAttribute("onclick", "oSpP.closePromptHelpText(false); return false;"), o.appendChild(s);
            var n = document.createElement("div");
            n.setAttribute("class", "backdrop-message"), n.innerHTML += a, o.appendChild(n), document.body.insertBefore(o, document.body.childNodes[0]), setTimeout(function () {
                oSpP.getDbValue("SPIDs", "PromptClosed", function (e) {
        ...
        if (o.os = t.getOS().name, void 0 !== H && 0 == H && (e = !1), e) {
            var s = document.createElement("div"),
                n = '<a class="sp-brand-link" rel="nofollow" target="_blank" href="' + B + (-1 !== B.indexOf("?") ? "&" : "?") + "utm_source=" + encodeURI(c.replace(/(^\w+:|^)\/\//, "")) + '&utm_medium=referral&utm_campaign=pushrequest">Web Push <span>SendPulse</span></a>';
            if (document.getElementsByClassName("sendpulse-backdrop-info").length) s.setAttribute("class", "sp-bottom-push-label sp-show"), s.innerHTML += n, document.getElementsByClassName("sendpulse-backdrop-info")[0].appendChild(s);
                ...
                var i = "sp-" + b.toLowerCase().replace(" ", ""),
                    r = "sp-lang-" + oSpP.getBrowserlanguage().toLowerCase().replace(" ", ""),
                    p = "sp-" + o.name.toLowerCase().replace(" ", ""),
                    a = p + o.major;
                s.setAttribute("style", "display:none"), s.setAttribute("class", "sp-webpush-label " + i + " " + p + " " + r + " " + a), s.setAttribute("onclick", "this.remove();");
        ...
        o.rel = "stylesheet", o.type = "text/css", o.href = "https://cdn.sendpulse.com/dist/css/push/sendpulse-prompt.min.css?v=" + R, o.media = "all", t.appendChild(o);
        ...
        if (0 < j.length) {
            ...
            "sendpulse-popover" === (s = (e = JSON.parse(j)).style) && (s = "sendpulse-native-popover");
            var a = document.createElement("div"),
                l = "sendpulse-prompt " + s;
            a.setAttribute("class", l), 0 < e.backgroundcolor.length && "sendpulse-fab" != s && (n = n + "background-color: " + e.backgroundcolor + ";"), a.setAttribute("style", n);
            var c = document.createElement("div");
            c.setAttribute("class", "sendpulse-prompt-message");
            var u = document.createElement("img");
            if (u.setAttribute("class", "sendpulse-bell-icon"), u.setAttribute("width", "14"), u.setAttribute("height", "14"), u.setAttribute("src", "https://cdn.sendpulse.com/img/push/icon-ring.svg"), i) {
                var d = document.createElement("span");
                d.setAttribute("class", "sp-link-wrapper"), (D = document.createElement("a")).setAttribute("class", "sp-link"), D.setAttribute("href", B), D.setAttribute("target", "_blank");
                var m = document.createElement("span");
                "sendpulse-modal" === s && (D.setAttribute("style", "color: " + e.textcolor + " !important;"), d.setAttribute("style", "color: " + e.textcolor + " !important;"), m.setAttribute("style", "color: " + e.textcolor + " !important;")), m.innerHTML = z[r], "sendpulse-bar" != s && (D.innerHTML = '<img src="data:image/svg+xml;base64,">'), D.appendChild(m), d.appendChild(D)
            }
            if ("sendpulse-native-popover" === s) {
                n = n + "color: " + e.textcolor + " !important;", a.setAttribute("style", n), void 0 !== e.custom && void 0 !== e.custom.prompt_position && (l += " sp-pos-" + e.custom.prompt_position, a.setAttribute("class", l)), (O = document.createElement("div")).setAttribute("class", "sendpulse-native-info-inner sp-table-wrapper");
                var S = document.createElement("div");
                S.setAttribute("class", "sp-cell"), u.setAttribute("src", "https://cdn.sendpulse.com" + e.icon), u.setAttribute("width", "64"), u.setAttribute("height", "64"), S.appendChild(u);
                var b = document.createElement("div");
                b.setAttribute("class", "sp-cell");
                var P = document.createElement("div");
                P.setAttribute("class", "sendpulse-prompt-info sendpulse-prompt-message-text"), P.innerHTML += V, b.appendChild(P), O.appendChild(S), O.appendChild(b)
            } else if ("sendpulse-bar" == s) {
                (O = document.createElement("div")).setAttribute("class", "sendpulse-prompt-info sendpulse-prompt-message-text"), O.setAttribute("style", "color: " + e.textcolor + " !important;"), O.innerHTML += V;
                ...
                if ((O = document.createElement("div")).setAttribute("class", "sendpulse-prompt-title sendpulse-prompt-message-text"), 0 < e.textcolor.length && O.setAttribute("style", "color: " + e.textcolor + " !important;"), O.innerHTML = U, (h = document.createElement("div")).setAttribute("class", "sendpulse-prompt-info sendpulse-prompt-message-text"), 0 < e.textcolor.length && h.setAttribute("style", "color: " + e.textcolor + " !important;"), h.innerHTML += V, void 0 !== e.custom && void 0 !== e.custom.prompt_size && "big" === e.custom.prompt_size) {
                    ...
                    g.setAttribute("class", "sp-cell");
                    var f = document.createElement("a");
                    f.innerHTML += '<svg viewBox="0 0 525.153 525.153" width="40" height="40" xmlns:xlink="http://www.w3.org/1999/xlink" class="sendpulse-bell-icon"><use class="sendpulse-bell-path bell-prompt-fab" style="fill: ' + e.textcolor + ' !important;" xlink:href="#sp_bell_icon" x="0" y="0">' + p + "</use></svg>", f.setAttribute("onclick", "oSpP.startSubscription(); return false;"), f.setAttribute("href", "#"), g.appendChild(f);
                    var v = document.createElement("div");
                    v.setAttribute("class", "sp-cell");
                    var w = document.createElement("a");
                    w.setAttribute("href", "#"), w.setAttribute("onclick", "oSpP.startSubscription(); return false;"), w.innerHTML = U, v.appendChild(w), O.appendChild(g), O.appendChild(v);
                    var D, y = document.createElement("div");
                    y.setAttribute("class", "sendpulse-prompt-label"), (D = document.createElement("a")).setAttribute("href", B), D.setAttribute("target", "_blank"), (m = document.createElement("span")).innerHTML = z[r], D.appendChild(m), y.appendChild(D)
                } else {
                    var A = document.createElement("div");
                    A.setAttribute("class", "sendpulse-prompt-fab sp_notify_prompt"), A.setAttribute("onclick", "oSpP.startSubscription(); return false;"), 0 < e.btncolor.length && A.setAttribute("style", "background-color: " + e.btncolor + " !important;"), A.innerHTML += p + '<svg viewBox="0 0 525.153 525.153" width="40" height="40" xmlns:xlink="http://www.w3.org/1999/xlink" class="sendpulse-bell-icon" ><use class="sendpulse-bell-path bell-prompt-fab" style="fill: ' + e.iconcolor + ' !important;" xlink:href="#sp_bell_icon" x="0" y="0" /></svg>'
                }
                void 0 !== e.custom && void 0 !== e.custom.prompt_position && (l += " sendpulse-fab-" + e.custom.prompt_position, a.setAttribute("class", l))
            } else if ("sendpulse-modal" == s || "sendpulse-safari" == s) {
                var O;
                (O = document.createElement("div")).setAttribute("class", "sendpulse-prompt-title sendpulse-prompt-message-text"), 0 < e.textcolor.length && O.setAttribute("style", "color: " + e.textcolor + " !important;"), O.innerHTML = U, (h = document.createElement("div")).setAttribute("class", "sendpulse-prompt-info sendpulse-prompt-message-text"), 0 < e.textcolor.length && h.setAttribute("style", "color: " + e.textcolor + " !important;"), h.innerHTML += V, "sendpulse-safari" == s ? (u.setAttribute("src", "https://cdn.sendpulse.com" + e.icon), u.setAttribute("width", "64"), u.setAttribute("height", "64"), c.appendChild(u)) : c.innerHTML += p + '<svg viewBox="0 0 525.153 525.153" width="40" height="40" xmlns:xlink="http://www.w3.org/1999/xlink" class="sendpulse-bell-icon"><use class="sendpulse-bell-path" style="fill: ' + e.textcolor + ' !important;" xlink:href="#sp_bell_icon" x="0" y="0" />  </svg>'
            }
            if ("sendpulse-fab" != s) {
                var x = document.createElement("div");
                x.setAttribute("class", "sendpulse-prompt-buttons");
                var T = document.createElement("button");
                T.setAttribute("class", "sendpulse-prompt-btn sendpulse-accept-btn sp_notify_prompt"), T.setAttribute("type", "button"), T.setAttribute("onclick", "oSpP.startSubscription();oSpP.closeCustomPrompt(false); return false;");
                var I = document.createElement("button");
                if (I.setAttribute("class", "sendpulse-prompt-btn sendpulse-disallow-btn"), I.setAttribute("type", "button"), I.setAttribute("onclick", "oSpP.sendPromptStat('prompt_denied');oSpP.closeCustomPrompt(true); return false;"), T.innerHTML = e.allowbtntext, I.innerHTML = e.disallowbtntext, T.setAttribute("style", "background-color:" + e.buttoncolor + " !important;border-color:" + e.buttoncolor + " !important;"), I.setAttribute("style", "color:" + e.buttoncolor + " !important;"), "sendpulse-native-popover" === s) {
                    var M = document.createElement("div");
                    M.setAttribute("class", "sp-table-wrapper");
                    var k = document.createElement("div");
                    k.setAttribute("class", "sp-cell"), i && void 0 !== d && k.appendChild(d);
                    var C = document.createElement("div");
                    C.setAttribute("class", "sp-cell"), C.appendChild(I);
                    var E = document.createElement("div");
                    E.setAttribute("class", "sp-cell"), E.appendChild(T), M.appendChild(k), M.appendChild(C), M.appendChild(E), x.appendChild(M)
                } else x.appendChild(I), x.appendChild(T);
                if (i && "sendpulse-modal" == s) {
                    var _ = document.createElement("div");
                    _.innerHTML = "&nbsp;", x.appendChild(_)
                }
            }
            if (c.appendChild(O), void 0 !== h && null != h && "sendpulse-native-popover" != s && c.appendChild(h), "sendpulse-fab" !== s ? (c.appendChild(x), i && void 0 !== d && "sendpulse-native-popover" !== s && x.appendChild(d), a.appendChild(c)) : void 0 !== e.custom.prompt_size && "big" === e.custom.prompt_size ? (a.appendChild(c), i && void 0 !== y && a.appendChild(y)) : (i && void 0 !== d && c.appendChild(d), a.appendChild(c), a.appendChild(A)), "sendpulse-fab" != s) {
                var L = document.createElement("button");
                L.setAttribute("class", "sendpulse-prompt-close"), L.setAttribute("onclick", "oSpP.closeCustomPrompt(false); return false;"), L.setAttribute("style", "color:" + e.textcolor + " !important;"), L.innerHTML = "&times;", a.appendChild(L)
            }
            if (document.body.insertBefore(a, document.body.childNodes[0]), "sendpulse-modal" == s) {
                var N = document.createElement("div");
                N.setAttribute("class", "sendpulse-prompt-backdrop"), N.setAttribute("style", "display:none;"), document.body.insertBefore(N, document.body.childNodes[1])
            }
            setTimeout(function () {
        ...
        for (var t = (e + "=".repeat((4 - e.length % 4) % 4)).replace(/\-/g, "+").replace(/_/g, "/"), o = window.atob(t), s = new Uint8Array(o.length), n = 0; n < o.length; ++n) s[n] = o.charCodeAt(n);
        return s
    }
}
