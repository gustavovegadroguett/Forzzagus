(function (n, t, x) {
    ...
    function ua(a, b) {
        ...
        if (.01 > Math.random()) try {
            var d = a && a.message || "";
            (c = -1 < d.indexOf("network error occurred") || -1 < d.indexOf("send beacon") && -1 < d.indexOf("Content Security Policy")) || (new Ra).log("jserrs", Fa, a.message, b, L.href, "", "string" === typeof a.stack && a.stack.replace(/\n/g, "\\n"))
        } catch (f) {}
    }

    function G(a, b, c, d) {
        return n.setTimeout(F(a, c || "setTimeout", d), b)
    }
    ...
    function Nb(a, b, c, d, f) {
        ...
        function C(a) {
            if (!a.nodeName) return a[ba] = -1, null;
            var e = +a[ba];
            ...
            b = 64;
            var c = 0,
                h = w.getElementParent(a),
                d = h && h[ba] ? h[ba] : 0;
            0 > d && (d = 0);
            var f = a.nodeName.toUpperCase(),
                p = ta[f];
            p || (b |= 2);
            var q = w.getElementNeighborPosition(a);
            q || (b |= 4);
            var B = w.getElementRegion(a);
            (h = h ? w.getElementRegion(h) : null) && B[0] == h[0] && B[1] == h[1] && B[2] == h[2] && B[3] == h[3] && (b |= 8);
            Ga[e].pos = B[0] + "x" + B[1];
            Ga[e].size = B[2] + "x" + B[3];
            a.id && "string" == typeof a.id &&
                (b |= 32);
            (h = w.calcTextChecksum(a)) && (b |= 16);
            var C = w.calcAttribChecksum(a);
            C && (c |= 2);
            a: {
                var A = w.getElementChildren(w.getElementParent(a), a.tagName);
                for (var H = 0; H < A.length; H++)
                    if ((!A[H].id || "string" != typeof A[H].id) && w.calcAttribChecksum(A[H]) == C && w.calcTextChecksum(A[H]) == h) {
                        A = !0;
                        break a
                    } A = !1
            }
            if (A) {
                b |= 1;
                var k = w.calcChildrenChecksum(a)
            }
            A = [];
            if (m(A, 1)) return null;
            r(A, e);
            g(A, b);
            r(A, d);
            p ? g(A, p) : u(A, f);
        ...
        function p(a, e, b, c, h, d) {
            ...
            if (!p) return null;
            var q = w.getElementXY(b);
            b = [];
            if (m(b, p)) return null;
            r(b, a);
            r(b, f);
            r(b, Math.max(0, c[0] - q[0]));
            r(b, Math.max(0, c[1] - q[1]));
        ...
        function Ta(a, e) {
            ...
            if (0 < b) {
                var c = [],
                    h = w.getElementRegion(e),
                    g = Ga[b],
                    d = h[0] + "x" + h[1],
                    f = h[2] + "x" + h[3];
                if (d != g.pos) {
                    g.pos = d;
                    if (m(c, 9)) return null;
                    r(c, a);
                    r(c, b);
                    r(c, h[0]);
                    r(c, h[1])
        ...
        function M(a) {
            var e = a[ba];
            if (!e || 0 > e || !/^INPUT|SELECT|TEXTAREA$/.test(a.nodeName) || !a.form || qa(a.form)) return null;
            ...
            for (var h = -1, g = a.form.elements, d = g.length, f = 0, p = 0; f < d; f++)
                if (g[f].name ==
                    a.name) {
                    if (g[f] == a) {
                        h = p;
            ...
            if (e && "SCROLLBAR" != e.nodeName) {
                if (/^INPUT|SELECT|TEXTAREA|BUTTON$/.test(e.tagName))
                    if (e[ba]) x(e);
                        ...
                        if (b) {
                            b = b.elements;
                            for (var c = b.length, h = 0; h < c; h++) /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(b[h].tagName) && !b[h][ba] && x(b[h])
                        } else x(e)
                    }
                else x(e);
                fa(p, [y.nowEventTime(), a.type, e, W.getPos(a), a.which, a.button])
            }
        }
        ...
        function da(a) {
            ...
            var e = "password" === a.type || X.test(a.name) || X.test(a.id),
                b = k.reduce(function (e, b) {
                    return e || U.generalRegex.test(a[b])
                }, !1, ["className", "id", "name"]) || U.placeholderRegex.test(a.placeholder),
                c = U.forceRecordRegex.test(a.className);
            return {
                forceRecord: c,
                ignore: e,
                isPrivate: b,
        ...
        function ra(a) {
            return "INPUT" == a.tagName ? "password" == a.type || a.name && X.test(a.name) || a.id && X.test(a.id) : !1
        }

        function O(a, e, b) {
            a = W.getTarget(a);
            var c = da(a);
            c.ignore || !c.forceRecord && (c.isPrivate && f.get("isEU") || v(a)) || (x(a), fa(h, [y.nowEventTime(),
                e, b, a, c.privateFlag
            ]))
        }
        ...
        function Y(a) {
            ...
            if ({
                    ...
                    144: 1,
                    145: 1
                } [e] || 112 <= e && 123 >= e || 96 <= e && 105 >= e || b & 16) 19 == e && 4 == (b & -17) && (e = 144), O(a, e, b | 16), sa = !1, k.setTimeout(function () {
                sa = !0
            }, 1, "fvl.keyDown"), !(67 == e && b & 4) || b & 1 || b & 2 || ca()
        }

        function ja(a) {
            sa && !Ma && 0 !== a.which && (O(a, a.charCode || a.keyCode, rb(a)), Ma = !0, k.setTimeout(function () {
                Ma = !1
            }, 1, "fvl.keyPress"))
        }
        ...
        function Z() {
            ...
            if ("string" == typeof b) {
                ...
                if (c) {
                    a = da(c).privateFlag || v(c, !0);
                    c = c.getElementsByTagName("*");
                    for (var h = 0; h < c.length && !a;) a = da(c[h]).privateFlag || v(c[h], !0), h++;
                    b != eb && (eb = b, b = a ? k.map(function () {
                        return U.obfuscatedSymbol
                    }, b.split("")).join("") : b, fa(e, [y.nowEventTime(), b]))
                }
            }
        }

        function ca() {
            fb || (fb = !0, eb && fa(B, [y.nowEventTime()]), k.setTimeout(function () {
                fb = !1
            }, 1, "fvl.copy"))
        }

        function N() {
            Aa || (Aa = !0, fa(H, [y.nowEventTime()]))
        }

        function E() {
            Aa && (Aa = !1, fa(A, [y.nowEventTime()]))
        }

        function P(a) {
            (!Aa || a && !a.fromElement) && N()
        }
        ...
        function F(a) {
            if ((a = W.getTarget(a)) && /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(a.tagName)) {
                ...
                fa(ea, [y.nowEventTime(), a])
            }
        }

        function J(a) {
            (a = W.getTarget(a)) && /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(a.tagName) && (x(a), fa(Sa, [y.nowEventTime(), a]))
        }

        function L(a) {
            if ((a = W.getTarget(a)) && !ra(a) && !v(a) && /^INPUT|SELECT|TEXTAREA$/.test(a.tagName)) {
                var e = da(a),
                ...
                x(a);
                fa(La, [y.nowEventTime(), a, b, e.privateFlag])
            }
        }

        function K(a) {
            if ((a = W.getTarget(a)) &&
                !qa(a) && "FORM" == a.nodeName) {
                for (var e = a.elements, b = 0; b < e.length; b++) w.isEmptyField(e[b]) || x(e[b]);
                fa(db, [y.nowEventTime(), a], !0)
            }
        }

        function Q(a) {
            (a = W.getTarget(a)) && "BODY" == a.tagName && T.append([], !0)
        }
        var T = new sb({
                protocol: a,
                counterId: b,
        ...
        if (!k.isMetrikaPlayer()) {
            z.on(t, "click,dblclick,mousedown", D);
            z.on(t, "mouseup", Ha);
            z.on(t, "keydown", Y);
            z.on(t, "keypress", ja);
            z.on(t, "copy", ca);
            if (w.getBody()) z.on(t, "mouseleave", Q);
            t.attachEvent && !n.opera ? (z.on(t, "focusin", P), z.on(t,
                "focusout", G)) : (z.on(n, "focus", N), z.on(n, "blur", E), z.on(t, "blur", E));
            t.addEventListener ? (z.on(t, "focus", F), z.on(t, "blur", J), z.on(t, "change", L), z.on(t, "submit", K)) : t.attachEvent && (z.on(t, "focusin", F), z.on(t, "focusout", J), function () {
                for (var a = t.getElementsByTagName("form"), e = 0; e < a.length; e++) {
                    for (var b = a[e].getElementsByTagName("*"), c = 0; c < b.length; c++)
                        if (/^INPUT|SELECT|TEXTAREA$/.test(b[c].tagName)) z.on(b[c], "change", L);
                    z.on(a[e], "submit", K)
                }
            }());
            (function () {
                ...
                if (a.length)
                    for (var e =
                            0; e < a.length; e++) {
                        var b = a[e].submit;
                        if ("function" == typeof b || "object" == typeof b && /^\s*function submit\(\)/.test(String(b))) a[e][Ia] = b, a[e].submit = function () {
                            K({
                                target: this
                            });
                            return this[Ia]()
        ...
        return {
            ...
            stop: function () {
                ...
                t.removeEventListener ?
                    (z.un(t, "focus", F), z.un(t, "blur", J), z.un(t, "change", L), z.un(t, "submit", K)) : t.detachEvent && (z.un(t, "focusin", F), z.un(t, "focusout", J), function () {
                        for (var a = t.getElementsByTagName("form"), e = 0; e < a.length; e++) {
                            for (var b = a[e].getElementsByTagName("*"), c = 0; c < b.length; c++) /^INPUT|SELECT|TEXTAREA$/.test(b[c].tagName) && z.un(b[c], "change", L);
                            z.un(a[e], "submit", K)
                        }
                    }());
                (function () {
                    for (var a = t.getElementsByTagName("form"), e = 0; e < a.length; e++) a[e][Ia] && (a[e].submit = a[e][Ia])
                })()
            }
        }
    }
    ...
    function I() {
        ...
        try {
            for (f = n.location, d = c; d--;) l = b[d], a[l] = "" + f[l]
        } catch (g) {
            L && (a = L)
        }
        return a
    ...
    function va() {
        return 0 == I().hostname.search(/^(.*\.)?((yandex(-team)?)\.(com?\.)?[a-z]+|(auto|kinopoisk|beru|bringly)\.ru|ya\.(ru|cc)|yadi\.sk|yastatic\.net|.*\.yandex)$/)
    }
    ...
    function Tb() {
        var a = n.performance && n.performance.getEntriesByType,
            b = a ? k.filter(Sb, n.performance.getEntriesByType("paint")) : [];
        if (b.length) return b = b[0], Math.round(b.startTime);
        if (a) return 0;
        if ("object" == typeof n.chrome && n.chrome.loadTimes) {
            if (b = n.chrome.loadTimes(), b.requestTime && b.firstPaintTime && n.performance && n.performance.timing) return Math.round(1E3 *
        ...
        if (wb) var Ub = function (a) {
            ...
            return b(b.s = 67)
                ...
                var r = c(2),
                    ...
                    C = {
                        ...
                        forof: function (a, b) {
                            a instanceof g.List ? a.forEach(b) : a instanceof m.KeyValue ? a.forEach(b) : Object(d.a)(a, b)
                        },
                        forin: function (a, b) {
                            Object(f.a)(a, b)
                        },
                        ...
                        toArray: function (a) {
                            return a instanceof g.List || a instanceof m.KeyValue ? q && a instanceof q || u && a instanceof u ? Object(l.a)(a) : a.toArray() : Object(l.a)(a)
                        },
                        toList: function (a) {
                ...
                var u = {
                    ...
                    isMonkeyPatchedOrUndefined: function (a, b) {
                        var c = f.a;
                        if (c[a] === x || !this.isNative(c[a], a)) return !0;
                        if (b)
                ...
                Object(a.a)(r, function (a) {
                    var b, e = r[a] instanceof m.a.Function;
                    q[a] = u ? e ? (b = r[a]).bind.apply(b, [r].concat(C)) : r[a] : e ? function () {} : r[a]
                }, !0);
                u && (q.devLog = r.log);
                b["default"] = q
            }, function (a, b, c) {
                ...
                try {
                    var m = /Android|webOS|iPhone|iPad|iPod|BlackBerry|Windows Phone/i.test(navigator.userAgent) ?
                        !0 : !1
                } catch (u) {
                    m = !1
                }
                ...
                b.a = function () {
                    var a =
                        "undefined" !== typeof global ? global : "undefined" !== typeof self ? self : n;
                ...
                var d = c(3),
                    ...
                    m = {
                        ...
                        isBlankOrSameOriginIframe: function (a, b) {
                            ...
                            return d && !d.match(/allow-same-origin/) || c && "about:blank" !== c && (c = g.StringUtils.parseURLNative(c).host) && (b || n).location.host !== c ? !1 : !0
                        },
                        ...
                        contentSizeChanged: function (a, b) {
                            var c = a.ownerDocument ? a.ownerDocument.defaultView : n,
                                g = {
                                    stopped: !1,
                                    height: null,
                                    width: null,
                        ...
                        offsets: function (a, b) {
                            ...
                            var e = (a.ownerDocument || t).defaultView || n,
                            ...
                            if (d || h) {
                                ...
                                h && (h = e.paddingRight, d = e.paddingBottom, m = e.paddingLeft, c += parseInt(e.paddingTop || "0", 10), g += parseInt(h || "0", 10), l += parseInt(d || "0", 10), f += parseInt(m || "0", 10))
                            }
                            return {
                                top: c,
                                right: g,
                ...
                var q = c.IGNORED_NODES,
                    ...
                    A = function (a) {
                        if (null == a) return !1;
                        a = a.nodeType;
                        return a === m.DOMUtils.NodeTypes.TEXT_NODE || a === m.DOMUtils.NodeTypes.COMMENT_NODE
                    },
                    k = function da(a, b) {
                        var e = [];
                        ...
                        if (a.childNodes && 0 < a.childNodes.length) {
                            c = a.childNodes;
                            for (var h = 0, g = c.length; h < g; h++) e.push.apply(e, da(c[h]))
                        }
                        return e
                    },
                    n = function (a, b, e) {
                    ...
                    La = function (a, b) {
                        var e = [];
                        a && (m.DOMUtils.nodeIsInTree(a) ?
                            n(null == a ? t.documentElement : a, function (a) {
                                e.push(a)
                        ...
                        if (db(a, b, c)) {
                            h = e.reduce(function (e, c) {
                                try {
                                    ...
                                    return u["default"].warn("Filtering error", Z), e
                                }
                            }, h);
                ...
                c = {
                    ...
                    getAttributes: function (a) {
                        ...
                        }), (c = h[e] || x) && g.IterableUtils.fastIterate(c, function (c, h) {
                            z(b, e, {
                                name: h,
                                value: a[h]
                            })
                    ...
                    isIgnoredNode: c,
                    isIgnoredAttr: Ta,
                    isAttributeNameValid: w,
                    isSkippedAttribute: function (a) {
                        return g.IterableUtils.includes(p,
                            a)
                    }
                };
                ...
                var m = function () {
                    ...
                    b.get = function (a) {
                        return (a = this.find(a)) ? a.value : x
                    };
                    b.keys = function () {
                    ...
                    var d = c(8),
                        ...
                        r = function () {
                            ...
                            c._saveEvent = function (a, b) {
                                ...
                                e = f[0];
                                f = f[1];
                                var p = this._events.get(e) || new d["default"];
                                c = this._options.get(e) || g.IterableUtils.toList(c);
                                var l = this._memory.get(e) || !1;
                                p.has(b) ||
                                    (p.add(b), this._events.set(e, p), this._options.set(e, c), this._saveNamespace(e, f, b), l && this._runCallback(e, b, l))
                            };
                    ...
                    var d = c(3),
                        ...
                        u = {
                                ...
                                return new a(function (a) {
                                    ...
                                    c.onselect = function () {
                                        try {
                                            ...
                                            m["default"].warn("Error while copying text " + b, e)
                                        }
                                        h.removeChild(c)
                                    };
                                    h.appendChild(c);
                            ...
                            requestAnimationFrame: function (a) {
                                ...
                                if (b && c) return this.requestAnimationFrame = b.bind(n), this.requestAnimationFrame(a);
                            ...
                            cancelAnimationFrame: function (a) {
                                var b = g.ObjectUtils.findNativeImplementation("requestAnimationFrame"),
                                    c = g.ObjectUtils.findNativeImplementation("cancelAnimationFrame");
                                b && c ? (this.cancelAnimationFrame = c.bind(n), this.cancelAnimationFrame(a)) : (this.cancelAnimationFrame = function (a) {
                                        clearTimeout(a)
                                    },
                                    clearTimeout(a))
                            },
                            ...
                            errorProxy: function (a, b, c) {
                                ...
                                try {
                                    ...
                                    return n.console.warn("Error while running " + (c || a.name), h), b
                                }
                            }
                        }
                    ...
                    l = {
                        ...
                        stringToBlobURL: function (a, b, c) {
                            ...
                            var g = function () {
                                ...
                                f = function (a) {
                                    return a ?
                                        (a = (URL || webkitURL).createObjectURL(a), /blob:(?!http[s]?).*/.test(a) ? a.replace("blob:", "blob:" + (c.protocol + "//" + c.host) + "/") : a) : x
                                }(g);
                            return g ? {
                                blob: g,
                                url: f
                                ...
                                return {
                                    ...
                                    assemble: function (a) {
                                        ...
                                        return a ? a.replace(/(\{([^}]+)\})/g, function () {
                                            return b[2 >= arguments.length ? x : arguments[2]]
                                        }) : this.url
                                    }
                                }
                            }
                                    ...
                                    if (!A) {
                                        ...
                                        p && m ?
                                            (p = !1, B = b, a.call(g, {
                                                ...
                                                timeDifff: 0,
                                                args: n
                                            })) : (H = c.now(), A = !0, G(function za() {
                                                var b = parseInt(c.now() - H, 10);
                                                b >= l ? (A = !1, H = c.now(), B !== h && (e = B, B = h, a.call(g, {
                                                    object: h,
                                                    prevObject: e,
                                                    timeDiff: b,
                                                    args: n
                ...
                var m = new RegExp("(" + c.join("|") + ")", "i"),
                    ...
                    q = {
                        ...
                        isValidNode: function (a) {
                            var b = a.nodeName;
                            a = a.type;
                            return "INPUT" === b ? !a || q.isValidType(a) : /textarea|select|progress/i.test(b)
                        },
                        ...
                        validate: function (a, b) {
                            ...
                            c = q.isRecordable(a);
                            var d = q.isPrivateInformationField(a);
                            e = q.isAllowed(a, "explicit" === g) && (!e || !d);
                            return {
                                forceRecord: c,
                                isPrivate: d,
                                isAllowed: e
                ...
                var d = {
                    ...
                    repeat: function (a, b) {
                        ...
                        c = function A() {
                            p ?
                                B(h) : (Date.now() - C >= q && (C = Date.now(), a.apply(f, l)), h = e(A))
                        };
                        c.stop = function () {
                            p = !0
                        };
                ...
                (function (a) {
                    ...
                    b.a = function (b, c) {
                        ...
                        if (b && c instanceof Function)
                            if (null != b[a.iterator])
                                if (g)
                                    if (b instanceof Array) {
                                        ...
                                        if (b[a.iterator])
                                            for (g = b, f = Array.isArray(g), m = 0, g = f ? g : g[a.iterator]();;) {
                                                if (f) {
                                                    if (m >= g.length) break;
                                                    var C = g[m++]
                                                } else {
                            ...
                            for (f = Object(d.a)(b), m = 0; m < f.length && (C =
                                    f[m], C = g ? c.apply(void 0, C) : c(C), !0 === C || !1 !== C); m++);
                    }
                    ...
                    b.a = function (b) {
                        ...
                        try {
                            if (b.forEach) b.forEach(function (a, b) {
                                ...
                                for (var q = b[a.iterator](), C, p; C = q.next(), p = C.value, !C.done;) c.push(p);
                            return c
                        } catch (h) {
                            return []
                        }
                    ...
                    l = {
                        ...
                        viewportGetter: function (a) {
                            ...
                            var b = a.defaultView,
                                ...
                                g = a.querySelector("ym-measure.ym-viewport"),
                            ...
                            return Object.defineProperties({
                                ...
                                orientation: {
                                    get: function () {
                                        var a = ka ? ka.orientation || ka.mozOrientation || ka.msOrientation : null;
                                        return a && a.angle || 0
                                    },
                                    configurable: !0,
                                    enumerable: !0
                ...
                (function (a, f, l) {
                    ...
                    a = function () {
                            ...
                            if (!1 === a.proxies.has(b)) {
                                ...
                                f.nodeIsRecordable(e) && d.properties && (f.forof(d.properties, function (a) {
                                    ...
                                    Object.defineProperty(b, a, {
                                        configurable: !0,
                                        value: function () {
                                            for (var h = arguments.length, g = Array(h),
                                                    d = 0; d < h; d++) g[d] = arguments[d];
                                            c.methodInvoked(b, a, g);
                                            return e.bind.apply(e, [b].concat(g))
                                        }
                                    })
                                }));
                                a.proxies.add(b)
                        ...
                        a.methodInvoked = function (a, b, c) {
                            ...
                            this.mocked && G(function () {
                                c = c.map(function (a) {
                                    return a instanceof Image ? p(a) : String(a)
                                });
                                e.send(a, "method", {
                                    name: b,
                                    args: c
                ...
                (function (a) {
                    ...
                    d = function () {
                        ...
                        c.push = function (b, c) {
                            var g, h = this;
                            void 0 === c && (c = !1);
                            (g = this.jobs).push.apply(g, [].concat(b));
                            c ? this.start(!0) : a.requestAnimationFrame(function () {
                                return h.start(c)
                            })
                        };
                        c.start = function (a) {
                        ...
                        c._executeJobsAsync = function () {
                            ...
                            if (this.hasJobs) {
                                ...
                                this.executionFrameId = a.requestAnimationFrame(function () {
                                    for (; b.hasJobs &&
                                        (!b.jobExecutionStartStamp || 150 > c);) c = b._executeJob(!b.jobExecutionStartStamp);
                        ...
                        c._executeJob = function (a) {
                            ...
                            try {
                                ...
                                m["default"].log("Error occurred when running job"), m["default"].log(C), m["default"].log(a.toString())
                            }
                    ...
                    f = {
                        ...
                        formatTime: function (a, b) {
                            ...
                            return [Math.floor(a / 3600),
                                Math.floor(a / 60 % 60), Math.floor(a % 60)
                            ].filter(function (a, b) {
                                return !(0 === a && 0 === b)
                            }).map(function (a, c) {
                        ...
                        formattedTime: function (a, b, c) {
                            ...
                            void 0 === c && (c = !0);
                            var g = f.formatTime(a, c).reverse();
                            return b.reduce(function (a, b, c) {
                                g[c] && parseInt(g[c], 10) && a.push(parseInt(g[c], 10) + " " + b);
                                return a
                            }, []).reverse().join(" ")
                        },
                        timer: a.a
            ...
            function (a, b) {
                ...
                function l(a) {
                    ...
                    if ((p === d || !p) && clearTimeout) return p = clearTimeout, clearTimeout(a);
                    try {
                        return p(a)
                    } catch (ea) {
                        try {
                ...
                function g() {
                    e && B && (e = !1, B.length ? h = B.concat(h) : H = -1, h.length && m())
                }
                ...
                var q = a.exports = {};
                try {
                    var C = "function" === typeof G ? G : c
                } catch (A) {
                    C = c
                }
                try {
                    var p = "function" === typeof clearTimeout ? clearTimeout : d
                } catch (A) {
                    p = d
                }
                var h = [],
                ...
                q.off = u;
                q.removeListener = u;
                q.removeAllListeners = u;
                q.emit = u;
                q.prependListener = u;
                q.prependOnceListener = u;
            ...
            function (a, b, c) {
                (function (a) {
                    ...
                    b.a = function (b) {
                        ...
                        if (b.headers === x || b.headers["Content-Type"] === x) c.headers = c.headers || {}, c.headers["Content-Type"] = function () {
                            switch (c.type) {
                                case "json":
                        ...
                        return (new a(function (a, b) {
                            ...
                            f.addEventListener("readystatechange", function () {
                                var h = f.status;
                                4 === f.readyState && (200 <= h && 301 > h ? "css" === c.type ? (h = ((f.getResponseHeader("Content-Type") || "").split("; ").map(function (a) {
                                    return a.split("\x3d")
                                }).find(function (a) {
                                    return "charset" === a[0]
                                }) || ["charset", "UTF-8"])[1], p.addEventListener("load", function (b) {
                                    a({
                                        result: p.result
                                    })
                                }), p.readAsText(f.response, h)) : (h = function (a) {
                                    switch (c.type) {
                                        case "json":
                                            return JSON.parse(a);
                                        case "html":
                            ...
                            f.send(c.data ? JSON.stringify(c.data) : x)
                        }))["catch"](function (a) {
                            return {}
                        })
                    }
            ...
            function (a, b, c) {
                (function (a, c) {
                    var d = function () {
                        ...
                        f = function (b) {
                            return b ? (b = this._getTime() - b, 0 > b && a.warn("Invalid stamp: " +
                                b), b) : 0
                        },
                        r = function (a, b) {
                            var c;
                    ...
                    b.a = function (a) {
                        ...
                        var b = a.getStamp || f,
                            ...
                            d = {
                                ...
                                log: function () {
                                    for (var a = arguments.length, b = Array(a), g = 0; g < a; g++) b[g] = arguments[g];
                                    c(b, this.stamp());
                                    return this
                                },
                    ...
                    b.a = function () {
                        ...
                        return {
                            ...
                            create: function (a) {
                                ...
                                f.forin(c, function (d) {
                                    b.add(a.attachEvent(a.document, d, g.handleInputChangeValueEvent, c[d]))
                                })
                            },
                            ...
                            handleInputValueChange: function (a, b, c) {
                                ...
                                if ((!b || -1 !== ["string", "boolean", "number"].indexOf(typeof b)) && b !== h) {
                                    if (e) c = this.recorder._getEventObject("change", a, {
                                        ...
                                        var g = m.a.validate(c, this.recorder.options);
                                        h = g.forceRecord;
                                        var d = g.isPrivate;
                                        g = g.isAllowed || h ? b : m.a.encode(b);
                    ...
                    b.a = function () {
                        var b = {
                            ...
                            l = function (a) {
                                ...
                                b = b.clientY;
                                b = void 0 === b ? null : b;
                                e = this.document.elementFromPoint(void 0 === g ? null : g, void 0 === d ? null : d) || e;
                        ...
                        return {
                            create: function (a) {
                                var g = a._universalHandler(q);
                                f.forin(b, function (h) {
                                    c.add(a.attachEvent(a.document, h, g, b[h]))
                                })
                            },
                            destroy: function (a) {
                        ...
                        return {
                            create: function (a) {
                                ...
                                c.forin(b, function (c) {
                                    g.add(a.attachEvent(a.document, c, f, b[c]))
                                })
                            },
                            destroy: function (a) {
                                c.forof(g,
                    ...
                    b.a = function () {
                        var b, c = function (b, c) {
                            ...
                            this._executeCaptor("deviceRotation", function () {
                                G(function () {
                                    var f = a.now() - d;
                                    g._publishActions(c.getValue.call(g, b, f))
                                }, 300)
                            })
                        };
                        return {
                    ...
                    b.a = function () {
                        var b = {
                            ...
                            f = function (a) {
                                ...
                                b && b.start !== b.end && -1 !== ["mousemove", "touchmove", "touchdown"].indexOf(a.type) ? (d = !0, a = this._getEventObject("selection", "select" === a.type ? a.target : this.rootNode, b), this._publishActions(a)) : d && -1 !== ["mousedown", "touchmove", "touchdown"].indexOf(a.type) && (d = !1, a = this._getEventObject("selection",
                                    null, {
                                        start: 0,
                                        end: 0
                                    }), this._publishActions(a))
                        ...
                        return {
                            create: function (a) {
                                var d = a._universalHandler(function (b) {
                                    ("mousemove" === b.type && 1 === b.which || -1 !== ["mousedown", "touchmove", "touchdown"].indexOf(b.type)) && f.call(a, b)
                                });
                                c.forin(b, function (c) {
                                    g.add(a.attachEvent(a.document, c, d, b[c]))
                                })
                            },
                            destroy: function (a) {
                                c.forof(g, function (b) {
                                    return a.removeEvent(b)
                                })
                            }
                        }
                            ...
                            h = function (a) {
                                ...
                                a.changedTouches &&
                                    0 < a.changedTouches.length && l.forof(a.changedTouches, function (a) {
                                        var b = void 0 === c ? !1 : c;
                                        if (d.has(a.identifier)) var e = d.get(a.identifier);
                                        else e = l.guid(), d.set(a.identifier, e);
                                        b && d["delete"](a.identifier);
                                        a.__id = e
                                    });
                                "touchmove" === a.type ? q ? k.call(this, {
                                    object: a,
                                    args: [b]
                                }) : p.call(this, a, b) : k.call(this, {
                                    object: a,
                                    args: [b]
                                })
                            };
                            ...
                            switch (a) {
                                case "childList":
                                    b = f.reduce(h.addedNodes, function (a, b) {
                                        !1 === c.added.has(b) && (a.push(b), q.c.walk(b, function (a) {
                                    ...
                                    h = f.reduce(h.removedNodes, function (a, b) {
                                        !1 === c.removed.has(b) && (a.push(b), q.c.walk(b, function (a) {
                                ...
                                case "attributes":
                                    ...
                                    if (h !== e) return {
                                        name: a,
                                        oldValue: q.c.normalizeAttributeValue(b, a, h),
                                        newValue: q.c.normalizeAttributeValue(b, a, e)
                                    };
                                    break;
                                case "characterData":
            ...
            function (a, b, c) {
                ...
                c = function () {
                    function a(a) {
                        ...
                        a !== x && this.setOption(a);
                        a = function () {
                            G(function () {
                                !0 === b._options.checkOnLoad && (!0 === b._options.debug && b._log("onload-\x3eeventCallback", "A check loading is launched"), null === b._var.bait && b._creatBait(), G(function () {
                                    b.check()
                                }, 1))
                            }, 1)
                        };
                        f.a.addEventListener !== x ? f.a.addEventListener("load", a, !1) : f.a.attachEvent("onload", a)
                    }
                    var b = a.prototype;
                    b._log = function () {};
            ...
            function (a, b, c) {
                (function (a) {
                    var d = c(1),
                        ...
                        u = c(16),
                        q = c(0);
                    d = "HTMLMediaElement" in n;
                    var k = {},
                        p = q.IterableUtils.toList(["addEventListener", "removeEventListener"]),
                        h = function () {
                            function b() {
                            ...
                            c.mock = function () {
                                var a = this,
                                    ...
                                    c = this;
                                q.IterableUtils.forof(k.properties, function (e) {
                                    if (p.has(e)) return !0;
                                ...
                                q.IterableUtils.forof(k.methods, function (e) {
                                    if (p.has(e)) return !0;
                                    var h = a.descriptor(b, e);
                                    a.originalDescriptors.set(e, h);
                            ...
                            c.remove = function () {
                                ...
                                q.IterableUtils.forof(this.originalDescriptors, function (b, c) {
                                    delete a[c];
                ...
                (function (a, f) {
                    ...
                    d = function (b) {
                        function c(c,
                            ...
                            var d = void 0 === h ? !1 : h;
                            h = b.call(this) || this;
                            u()(m()(h), "eventsList", ["initialIndex:once:memory", "add", "remove", "node"]);
                            h.disabled = d;
                            h.nextID = 0;
                            h.closed = !1;
                            h.dom = new a;
                        ...
                        d.addToIndex = function (a, b, c) {
                            ...
                            if (a = this.middleware.run(a)) {
                                ...
                                if (!1 === this.dom.has(a) || null == e) c = this.generateNodeID(c), e = {
                                    ...
                                    parent: b,
                                    nativeNode: a,
                                    namespace: q.c.getNamespace(a),
                                    attributes: q.c.getAttributes(a),
                                    content: q.c.getContent(a)
                                }, this.domCache && this.writeCache(c, a, e), this.dom.set(a, e), this.index.set(c, a), a._DOMIndexerID = c, a._DOMIndexerInfo = e;
                                this.emit("add", e);
                                return e
                            }
                            H["default"].warn("Can't index undefined node")
                        };
                        d.clear = function (a) {
                            void 0 === a && (a = !0);
                            p.IterableUtils.forof(p.IterableUtils.keys(this.dom), function (a) {
                                p.IterableUtils.forof(["_DOMIndexerID", "_DOMIndexerInfo"], function (b) {
                                    a[b] =
                                        null;
                                    delete a[b]
                                })
                        ...
                        d.getNodesIds = function (a) {
                            var b = this;
                            return p.IterableUtils.toArray(a).map(function (a) {
                                return {
                                    id: b.getNodeId(a),
                        ...
                        d.reindexNodeTree = function (a, b) {
                            ...
                            if (a) {
                                var p = [];
                                if (a.parentNode || B) f = e.FunctionUtils.toFunction(f), q.c.each(a, function (a, b) {
                        ...
                        d.removeFromIndex = function (a) {
                            ...
                            this.dom["delete"](a);
                            this.index["delete"](b);
                            p.IterableUtils.toArray(a.childNodes).map(this.removeFromIndex.bind(this));
                            this.emit("remove", a);
                            return b
                        };
                        ...
                        d.showMissingNodes = function (a) {
                            ...
                            a && B.Tools.measure("Show missing nodes", function () {
                                var a = q.c.all(b.document.documentElement);
                                p.IterableUtils.fastIterate(a,
                                    function (a, c) {
                                        !1 === b.dom.has(c) && H["default"].log("Missing node", c)
                                    });
                                H["default"].log("Index diff: [DOM: " + a.length + "] [INDEX: " + b.dom.size + "] [DIFF: " + (b.dom.size - a.length) + "]")
                            })
                        };
                        d.getCurrentHtml = function () {
                            var a = p.IterableUtils.map(this.dom, function (a) {
                                return a[1]
                            });
                            return c.simplify(a)
                        };
                    ...
                    u()(d, "simplify", function (a) {
                        return p.IterableUtils.map(a, function (a) {
                            var b = {
                                id: a.id,
                                name: a.name.toLowerCase()
                            };
                            p.IterableUtils.forof(A, function (c) {
                                null != a[c] && (b[c] = a[c])
                            });
                            return b
                        })
                    ...
                    u()(d, "toNodesTree", function (a) {
                        var b = {};
                        a = p.IterableUtils.toArray(a);
                        p.IterableUtils.forof(a, function (a) {
                            if (null == b[a.id]) {
                    ...
                    d = function () {
                        ...
                        c.send = function (a, b) {
                            var c = this,
                                ...
                                C, n = [],
                                t = Date.now();
                            "function" === typeof g && (q = !0, u = a + "." + this.timestamp, this.listenOnce(function (a) {
                                var b = a.data,
                            ...
                            (function Ha() {
                                ...
                                if (l && q) {
                                    ...
                                    void 0 === b && (b = 3E4);
                                    b = Date.now() - t >= b;
                                    !1 === k && (b ? "function" === typeof f && f() : C = G(Ha, 100))
                                }
                            })()
                        };
                            ...
                            if (null == this._cancelMainHandler) {
                                var b = this._attachEvent("message", function (b) {
                                    ...
                                    if (!0 === c._ym_messenger && g && !/\.([0-9]+)$/.test(g)) {
                                        ...
                                        var f = a._findIframe(b.source, h);
                                        if (null === f) r["default"].warn("Cannot find iframe with id " + h);
                                        else {
                                            var p = {
                                                id: h,
                                                sender: f,
                        ...
                        c._findIframe = function (b, c) {
                            var e = this,
                                h = [].slice.call(t.querySelectorAll("iframe"));
                            return a.find(h, function (a) {
                    ...
                    var g = c(0),
                        ...
                        u = {
                            ...
                            resetMultiple: function () {
                                for (var a, b = this, c = arguments.length, e = Array(c), h = 0; h < c; h++) e[h] = arguments[h];
                        ...
                        B = function () {
                            var a = h(function () {
                                if (q.base) return q.base;
                                if (q.document) {
                                    var a = q.document.querySelector("base[href]");
                                    return a ? a.href : q.location
                                }
                                return q.location
                            }());
                            return q.location = {
                    ...
                    d = Object.defineProperties({
                        ...
                        patchCSS: function (a, b) {
                            ...
                            return ["cssURLFinder", "URLImportFinder"].reduce(function (a, b) {
                                return c.patchURLS(a, u.get(b), h, d[b])
                            }, a)
                        },
                        patchURLS: function (a, b, c, e) {
                            ...
                            "string" === typeof a && a.match(b) && (d = a.replace(b, function () {
                                var a = h.patchURL(2 >= arguments.length ? x : arguments[2], {
                                    location: c
                                });
                                return g(a)
                            }));
                        ...
                        patchURL: function (a, b) {
                            ...
                            return "string" === typeof a ? function (a) {
                                ...
                                e = e.slice(1);
                                h = c.applyPatch(h, d);
                                a.push([h].concat(e).join(" "));
                                return a
                            }, []).join(", ") : a
                        },
                        applyPatch: function (b, c) {
                            var e = u.test("relativePath", b),
                                h = this.getRelativeLocation(c),
                                d = h.host,
                                g = h.protocol;
                            h = h.path || h.pathname || "";
                            e = e ? this.resolvePath(b, h) : b;
                            if (0 <= H.indexOf(e)) return e;
                            if (p.has(e)) return k.get(e);
                            h = b;
                            u.resetAll();
                            if (u.test("dataurlTest", b) || u.test("selectorTest", b)) return b;
                            u.test("protocolMissing", b) && (h = u.test("protocolIncomplete", b) ? b.replace(u.get("protocolIncomplete"), g + "//") : g + "//" + (d + "/" + e).replace(/\/\/+/, "/"));
                            p.set(b, h);
                            /http[s]?/.test(h) ? (d = h, u.test("proxiedURL", d) ? h = d : (q.isWhitelisted ? (g = q.isWhitelisted(d)) && a.warn("Whitelisted: " + d) : g = !1, h = g ? d : (g = q.proxy) && u.test("resourceFinder", g) ? g.replace(u.get("resourceFinder"), d.replace(/&/g, "%26")) : d), H.push(h),
                                k.set(b, h), d = h) : (H.push(b), k.set(b, h), d = b);
                            return q.noEncode ? decodeURIComponent(d) : d
                        },
                        getRelativeLocation: function (a) {
                            var b = u.test("relativePath", a);
                            return a ? b ? (b = m.StringUtils.parseURL(e(a)), a = this.resolvePath(a, this.location.protocol + "//" + this.location.host + (this.location.path || this.location.pathname || "")), b || r.ObjectUtils.assign({}, this.location, {
                                path: a
                        ...
                        resolvePath: function (a, b) {
                            ...
                            for (var c = (b.replace(/\/[^\/]*$/, "") + "/" + a).split("/"), e = [], h = 0, d = c.length; h < d; h++) {
                                var g = c[h];
                        ...
                        configure: function (a) {
                            ...
                            q = r.ObjectUtils.assign({}, q, b);
                            if (a) {
                                a = a.map(function (a) {
                                    return a.replace("*", "(.*)")
                                }).join("|");
                                var c = new RegExp("" + a, "ig");
                                q.isWhitelisted = function (a) {
                                    c.lastIndex = 0;
                                    return c.test(a)
                                }
                            }
                        ...
                        location: {
                            ...
                            set: function (a) {
                                return (q = r.ObjectUtils.assign({}, q, {
                                    location: a
                                })).location
                            },
                            configurable: !0,
            ...
            function (a, b, c) {
                function d() {
                    try {
                        ...
                        var a = n.sessionStorage.getItem(l),
                            b = !1;
                        try {
                            var c = n.opener ? n.opener.sessionStorage : null;
                            b = !!c && a === c.getItem(l)
                        } catch (u) {
                            b = !0
                        }
                        if (!a || b) a = f.Tools.guid(), n.sessionStorage.setItem(l, a);
                        return a
                    } catch (u) {
                        return null
                    }
                        ...
                        var a = new d.a,
                            ...
                            e = function (e) {
                                ...
                                a.push(function () {
                                    d !== b && (c = 0);
                                    b = d;
                                    h._publishMutations(h._getMutationObject(g, d, c++))
                                })
                            };
                        return {
                            create: function (a) {
                        ...
                        var a, b = function (a, b) {
                            var c = 0,
                                e = function () {
                                    ...
                                    h && (0 !== h.stamp ? this._publishActions(h) : 3 > c && (G(e, 300), c += 1))
                                }.bind(this);
                            e()
                        };
                        return {
            ...
            function (a, b, c) {
                ...
                (function (a, f, l) {
                    ...
                    var E = c(56),
                        ...
                        T = {
                            counterId: null,
                            maxSize: R.NumberUtils.size(50, "mb"),
                            maxDuration: 864E5,
                            compression: !1,
                            isEU: !1,
                            recording: {
                        ...
                        ma = !0 === ra.a,
                        U = P.IS_INCOGNITO || P.DO_NOT_TRACK || "disable" === ca.BrowserUtils.meta("webvisor"),
                        ia = n !== n.top;
                    n.__YM_WV_RECORDABLE__ === x && Object.defineProperty(n, "__YM_WV_RECORDABLE__", {
                        value: !0
                    });
                    var X = function (b) {
                            function c(c, d) {
                                ...
                                e()(p()(h), "middlewares", []);
                                e()(p()(h), "options", ha.ObjectUtils.assign({}, T));
                                e()(p()(h), "initOptions", ha.ObjectUtils.assign({}, ta));
                                e()(p()(h), "iframes", []);
                                e()(p()(h), "waitingBody", null);
                                e()(p()(h), "ableToStart",
                                    !1);
                                e()(p()(h), "_identifier", B.Tools.guid());
                                e()(p()(h), "offsets", {
                                    left: 0,
                                    top: 0
                                });
                                e()(p()(h), "fatalError", !1);
                                e()(p()(h), "captors", new a);
                                e()(p()(h), "prevMutationStamp", null);
                                e()(p()(h), "prevMutationOrderingID", 0);
                                e()(p()(h), "inited", !1);
                                e()(p()(h), "startOptions", null);
                                e()(p()(h), "precache", []);
                                e()(p()(h), "paused", !0);
                                e()(p()(h), "started", !1);
                                e()(p()(h), "stopped", !1);
                                e()(p()(h), "snapshotSent", !1);
                                e()(p()(h), "eventsList", ["error"]);
                                e()(p()(h), "_slaveMessengerRegistrationHandler", function (a, b) {
                                    return function (c,
                                        e) {
                                        var d = c.offsets,
                                            g = c.counterId,
                                        ...
                                        try {
                                            ...
                                            m || r && p ? (h.offsets = d, h.sender.useRight(function (a) {
                                                var b = a.data,
                                                    c = {};
                                            ...
                                            })) : V["default"].warn("Counter or domain mismatch, iframe will be recorded as master window");
                                            return a()
                                        } catch (Pb) {
                                            b(Pb)
                                        }
                                ...
                                e()(p()(h), "_sendEOF", H.FunctionUtils.once(function () {
                                    if (!h._EOF_SENT) {
                                ...
                                h._context = function (a) {
                                    var b = {};
                                    return a ? (b.window = a.window || n, b.document = a.document || t, b) : {
                                        window: n,
                                        document: t
                                    }
                                }(d);
                                h.sender = new v.a(h.middlewares.splice(0));
                                h.captors = new a;
                                h._timer = Ba.TimeUtils.timer();
                                h._tabId = Object(Z.a)();
                                h._configOptions = q()({}, c);
                                Object.defineProperty(h.window, "__WV_ENABLED__", {
                                    value: !0
                                });
                                return !ma || U ? p()(h) || p()(h) : h
                            }
                            h()(c,
                                b);
                            var d = c.prototype;
                            d.configure = function () {
                                var a = ha.ObjectUtils.combine({}, q()({}, T, this._configOptions));
                                this.frames = [];
                                ...
                                this.precache = [];
                                this.options = q()({}, a);
                                this.canvasProxy = w.a;
                                this.MediaProxy = F.a;
                                ja.c.addAttributesFilter(function (b, c, e) {
                                    if (D.a.isValidNode(b) && "value" ===
                                        c) return b = D.a.validate(b, a), c = b.forceRecord, b.isAllowed || c ? e : D.a.encode(e)
                                })
                            };
                            d.attachEvent = function () {
                                for (var a, b = arguments.length, c = Array(b), e = 0; e < b; e++) c[e] = arguments[e];
                                K.a.on.apply(K.a, (a = []).concat.apply(a, c));
                                return c
                            };
                            d.removeEvent = function () {
                                for (var a, b = arguments.length, c = Array(b), e = 0; e < b; e++) c[e] = arguments[e];
                                K.a.off.apply(K.a, (a = []).concat.apply(a, c));
                                return c
                            };
                            d["continue"] = function () {
                                U || (this.paused = !1)
                            ...
                            d.init = function (a) {
                                ...
                                this.errorLogger(u()(r.a.mark(function Ia() {
                            ...
                            d.__initIndexer =
                                function () {
                                    var a = this;
                                    this.indexer = new qa.a(this.document, {
                                        disabled: this.initOptions.disableIndex
                                    });
                                    if (q()({}, this.options).childIframe) this.indexer.on("node", function (b) {
                                        return a.connectSlaveRecorder(b)
                                    });
                                    this.indexer.use(S.a);
                            ...
                            d.connectSlaveRecorder = function (a) {
                                var b = this;
                                if ("IFRAME" === a.nodeName && a.name !== ea.a.NATIVE_IFRAME_NAME && N.DOMUtils.isBlankOrSameOriginIframe(a, this.window)) {
                                    try {
                                    ...
                                    var e = function cb(a) {
                                            var c = a.contentWindow,
                                                e = a.contentDocument;
                                            V["default"].log("creating recorder");
                                            if (c && e) {
                                                if (!0 === c.__YM_WV_RECORDABLE__) return V["default"].warn("Iframe has internal counter installed");
                                                if (!0 === c.__YM_RECORDING__) return V["default"].warn("We're already recording this iframe", a);
                                                ...
                                                return V["default"].info("Recorder injected into the iframe", a)
                                            }
                                            G(function () {
                                                return cb(a)
                                            }, 10)
                                        ...
                                        d = function (c) {
                                            b.errorLogger(function () {
                                                if (c && c.parentElement && c.contentDocument && N.DOMUtils.isBlankOrSameOriginIframe(a, b.window) && !0 !== c.contentWindow.__WV_ENABLED__) try {
                                                    e(c)
                                                } catch (cb) {
                                                    V["default"].error(cb),
                                                        V["default"].warn("Probably this iframe is cross-origin")
                                                }
                                            }, "ifLo")
                                        };
                            ...
                            d.start = function (a) {
                                ...
                                this.errorLogger(function () {
                                    if (b.ableToStart)
                                        if (!1 === b.fatalError)
                                            if (!b.inited) b.savePageSnapshot(), b.fatal("init-failed", Error("Unknown error"));
                                                ...
                                                if (ma && !U) {
                                                    clearTimeout(b.cancelIfNotStarted);
                                                    var c = (a || {}).forms;
                                                    b.options.recording = ha.ObjectUtils.combine({}, T.recording, {
                                        ...
                                        b.ableToStart ? b.start(a) : G(Ka, 50)
                                    })()
                                }, "start")
                            };
                            d.stop = function (a, b) {
                                ...
                                void 0 === a && (a = !1);
                                void 0 === b && (b = !0);
                                ma && !U && (!1 !== this.started && this.inited || a) && !0 !== this.stopped && (clearTimeout(this.cancelIfNotStarted),
                                    clearTimeout(this.sendErrors), this.captors.forEach(function (a) {
                                        a && a.hasOwnProperty("destroy") && a.destroy(c)
                                    }), this.indexer && this.indexer.clear(), this.captors && this.captors.clear(), O.a.invokeAll(this), this.summary && this.summary.destroy(), this.keyCapture && this.keyCapture.destroy(), b ? (this._sendEOF(), !0 === this.fatalError && this._sendPreCachedData({
                                        force: !0
                            ...
                            d._initCaptors = function () {
                                ...
                                var b = ha.ObjectUtils.combine({}, ea.a.captors, ia ? ea.a.iframeCaptors : null);
                                ...
                                K.a.on(this.window, "beforeunload", this.stop.bind(this))
                            };
                            ...
                            d._initMessenger = function () {
                                ...
                                return new f(function () {
                                    var b = u()(r.a.mark(function Ka(b) {
                                        var c;
                                        return r.a.wrap(function (e) {
                                            for (;;) switch (e.prev = e.next) {
                                                case 0:
                                                    a.messenger = new Q.a(a.window);
                            ...
                            d._initMasterMessenger = function () {
                                ...
                                this.messenger.subscribe("iframe_register", function (a, c) {
                                    var e = N.DOMUtils.offsets(a.sender);
                                    c({
                                ...
                                this.messenger.subscribe("iframe_data", function (b) {
                                    ...
                                    if (null != e) {
                                        ...
                                        if (c.events) {
                                            b = N.DOMUtils.offsets(b, {
                                                excludeBorder: !0
                                            });
                                            var h = b.left,
                                                g = b.top;
                                            b = c.events.map(function (b) {
                                                /mouse/.test(b.type) && (b.meta.x = Math.round(b.meta.x + h), b.meta.y = Math.round(b.meta.y + g));
                                                return q()({}, b, d, {
                            ...
                            d._initSlaveMessenger = function () {
                                ...
                                return (new f(function (b, c) {
                                    V["default"].log("Awaiting subscription", a.document.documentElement);
                                    a.messenger.send("iframe_register", {
                                        awaitResponse: !0,
                                        timeoutTime: 3E3,
                                        onResponse: a._slaveMessengerRegistrationHandler(b, c),
                                        onTimeout: function () {
                                            V["default"].warn("Slave recorder stopped due to a timeout: no response from the parent page within 1 seconds. This frame will be used as if it is master");
                                            b()
                                        }
                                    })
                                }))["catch"](function (b) {
                                    V["default"].warn("Cant init recorder in frame");
                                    a.throwError(b, "slave-recorder");
                                    V["default"].warn(b, a.document);
                                    return b
                                })
                            };
                            ...
                            d._request = function (a, b, c) {
                                ...
                                this._EOF_SENT && !0 !== c || (!0 === this.started || !0 === c ? (b = ha.ObjectUtils.combine({
                                    _v: ea.a["package"].version
                                }, q()({}, b)), this.sender.send({
                                    url: a,
                                    data: q()({}, b)
                                ...
                                this.snapshot = {
                                    get: function (c) {
                                        ...
                                        return b.then(function (b) {
                                            var c = b.error;
                                            b = b.content;
                                            c ? (b = d.call(a, b, c), a.fatal("invalid-snapshot",
                                                c)) : b = e.call(a, b);
                                            return b
                                        })
                                    }
                            ...
                            d.savePageSnapshot = function (a) {
                                if (this.indexer && !this.indexer.disabled && !this.snapshotSent) return this.snapshotSent = !0, a = q()({
                                    content: a,
                                    frameId: 0,
                                    tabId: this.tabId,
                                    recordStamp: (new Date).getTime()
                            ...
                            d._sendMessage = function (a, b) {
                                (ia ? this.window.top : this.window).postMessage({
                                        type: a,
                                        data: b
                                    },
                                    "*")
                    ...
                    A.IterableUtils.forin(sa, function (a) {
                        var b = {
                            value: sa[a]
                        };
                        Object.defineProperty(X, a, b);
                        Object.defineProperty(X.prototype, a, b)
                    })
                }).call(this, c(12)["default"], c(22).Promise,
                    c(8)["default"])
            },
            ...
            function (a, b, c) {
                (function (b) {
                    ...
                    a.exports = q = function ea(a) {
                        if (this instanceof ea) throw new TypeError("Symbol is not a constructor");
                        if (h) return p(a);
                        var b = g(B.prototype);
                        a = a === x ? "" : String(a);
                        return m(b, {
                    ...
                    m(q, {
                        ...
                        hasInstance: d("", p && p.hasInstance || q("hasInstance")),
                        isConcatSpreadable: d("", p && p.isConcatSpreadable || q("isConcatSpreadable")),
                        iterator: d("", p && p.iterator || q("iterator")),
                        match: d("", p && p.match || q("match")),
                        replace: d("", p && p.replace || q("replace")),
                        search: d("", p && p.search || q("search")),
                        species: d("",
                            p && p.species || q("species")),
                        split: d("", p && p.split || q("split")),
                        toPrimitive: d("", p && p.toPrimitive || q("toPrimitive")),
                        toStringTag: d("", p && p.toStringTag || q("toStringTag")),
                        unscopables: d("", p && p.unscopables || q("unscopables"))
                    });
                    m(B.prototype, {
                        constructor: d(q),
                        toString: d("", function () {
                    ...
                    r(q.prototype, q.toPrimitive, d("", function () {
                        var a = l(this);
                        return "symbol" ===
                            typeof a ? a : a.toString()
                    }));
                    r(q.prototype, q.toStringTag, d("c", "Symbol"));
                    r(B.prototype, q.toStringTag, d("c", q.prototype[q.toStringTag]));
                    r(B.prototype, q.toPrimitive, d("c", q.prototype[q.toPrimitive]))
                }).call(this, c(25)["default"])
            },
            function (a, b, c) {
                var d = c(72),
                ...
                (a.exports = function (a, b) {
                    ...
                    if (null == a) {
                        var m = c = !0;
                        var p = !1
                    } else m = g.call(a, "c"), p = g.call(a, "e"), c = g.call(a, "w");
                    m = {
                        value: b,
                        configurable: m,
                        enumerable: p,
                    ...
                    "string" !== typeof a && (k = c, c = b, b = a, a = null);
                    null == b ? b = x : l(b) ? null == c ? c = x : l(c) || (k = c, c = x) : (k = b, b = c = x);
                    if (null == a) {
                        var m = !0;
                        a = !1
                    } else m = g.call(a, "c"), a = g.call(a, "e");
                    b = {
                        get: b,
                        set: c,
                        configurable: m,
            ...
            function (a, b, c) {
                var d = c(75),
                    ...
                    l = Math.max;
                a.exports = function (a, b) {
                    var c, g, m = l(arguments.length, 2);
                    a = Object(f(a));
                    var k = function (d) {
                        try {
                            a[d] = b[d]
                    ...
                    for (g = 1; g < m; ++g) b = arguments[g], d(b).forEach(k);
                    if (c !== x) throw c;
                    return a
                }
            },
            ...
            function (a, b, c) {
                a.exports = function (a) {
                    return a ? "symbol" === typeof a ? !0 : a.constructor && "Symbol" === a.constructor.name ? "Symbol" === a[a.constructor.toStringTag] :
                        !1 : !1
                }
            },
            function (a, b, c) {
                (function (b) {
                    (function (b, c) {
                        ...
                        function q() {
                            for (var a = 0; a < da; a += 2)(0, N[a])(N[a + 1]), N[a] = x, N[a + 1] = x;
                            da = 0
                        }
                        ...
                        function ea(a, b) {
                            b._state === V ? v(a, b._result) : b._state === R ? D(a, b._result) : E(b, x, function (b) {
                                return z(a, b)
                            }, function (b) {
                                return D(a, b)
                            })
                        ...
                        function w(b, c, e) {
                            c.constructor === b.constructor && e === p && c.constructor.resolve ===
                                h ? ea(b, c) : e === S ? (D(b, S.error), S.error = null) : e === x ? v(b, c) : a(e) ? A(b, c, e) : v(b, c)
                        }
                        ...
                        function z(a, b) {
                            if (a === b) D(a, new TypeError("You cannot resolve a promise with itself"));
                                ...
                                var c = typeof b;
                                null === b || "object" !== c && "function" !== c ? v(a, b) : w(a, b, B(b))
                            }
                        }
                        ...
                        function v(a, b) {
                            a._state === ha && (a._result = b, a._state = V, 0 !== a._subscribers.length && Y(F, a))
                        }

                        function D(a, b) {
                            a._state === ha && (a._state = R, a._result = b, Y(y, a))
                        }
                        ...
                        function F(a) {
                            var b = a._subscribers,
                                c = a._state;
                            if (0 !== b.length) {
                                for (var e, d, h = a._result, g = 0; g < b.length; g += 3) e = b[g], d = b[g + c], e ? J(c, e, d, h) : d(h);
                        ...
                        function J(b, c, e, d) {
                            ...
                            c._state === ha &&
                                (h && l ? z(c, g) : B ? D(c, f) : b === V ? v(c, g) : b === R && D(c, g))
                        }
                        ...
                        var I = void 0,
                            Q = I = Array.isArray ? Array.isArray : function (a) {
                            ...
                            ja = (I = "undefined" !== typeof n ? n : x) || {},
                            Z = ja.MutationObserver || ja.WebKitMutationObserver;
                        ja = "undefined" ===
                            typeof self && "undefined" !== typeof b && "[object process]" === {}.toString.call(b);
                        var ca = "undefined" !== typeof Uint8ClampedArray && "undefined" !== typeof importScripts && "undefined" !== typeof MessageChannel,
                            N = Array(1E3),
                            Ba = void 0;
                        Ba = ja ? c() : Z ? m() : ca ? r() : I === x ? C() : k();
                        var P = Math.random().toString(36).substring(2),
                            ...
                            aa = function () {
                                function a(a, b) {
                                    ...
                                    this.promise[P] || L(this.promise);
                                    Q(b) ? (this._remaining = this.length = b.length, this._result =
                                        Array(this.length), 0 === this.length ? v(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(b), 0 === this._remaining && v(this.promise, this._result))) : D(this.promise, Error("Array Methods must be provided an Array"))
                                }
                                a.prototype._enumerate = function (a) {
                                    for (var b = 0; this._state === ha && b < a.length; b++) this._eachEntry(a[b], b)
                                };
                                a.prototype._eachEntry = function (a, b) {
                                    var c = this._instanceConstructor,
                                        d = c.resolve;
                                    d === h ? (d = B(a), d === p && a._state !== ha ? this._settledAt(a._state, b, a._result) : "function" !== typeof d ?
                                        (this._remaining--, this._result[b] = a) : c === T ? (c = new c(e), w(c, a, d), this._willSettleAt(c, b)) : this._willSettleAt(new c(function (b) {
                                            return b(a)
                                        }), b)) : this._willSettleAt(d(a), b)
                                };
                                a.prototype._settledAt = function (a, b, c) {
                                    var e = this.promise;
                                    e._state === ha && (this._remaining--, a === R ? D(e, c) : this._result[b] = c);
                                    0 === this._remaining && v(e, this._result)
                                };
                                a.prototype._willSettleAt = function (a, b) {
                                    var c = this;
                                    E(a, x, function (a) {
                                        return c._settledAt(V, b, a)
                                    }, function (a) {
                                        return c._settledAt(R, b, a)
                                    })
                                };
                                return a
                            }(),
                ...
                (function (b, c) {
                    ! function (d) {
                        ...
                        function p(a) {
                            function b(e, d, h, g) {
                                ...
                                if ("throw" === e.type) g(e.arg);
                                    ...
                                    var l = e.arg;
                                    return (e =
                                        l.value) && "object" === typeof e && w.call(e, "__await") ? c.resolve(e.__await).then(function (a) {
                                        b("next", a, h, g)
                                    }, function (a) {
                                        b("throw", a, h, g)
                        ...
                        function h(a, b, c) {
                            var d = G;
                            return function (h, g) {
                                if (d === K) throw Error("Generator is already running");
                                if (d === L) {
                                    if ("throw" === h) throw g;
                                    return t()
                                }
                        ...
                        function e(a, b) {
                            ...
                            if (c === x) {
                                ...
                                if ("throw" === b.method) {
                                    if (a.iterator["return"] &&
                                        (b.method = "return", b.arg = x, e(a, b), "throw" === b.method)) return I;
                                    b.method = "throw";
                            ...
                            if (c.done) b[a.resultName] = c.value, b.next = a.nextLoc, "return" !== b.method && (b.method = "next", b.arg = x);
                            else return c;
                            b.delegate = null;
                            return I
                        }
                        ...
                        function ea(a) {
                            if (a) {
                                ...
                                if (!isNaN(a.length)) {
                                    ...
                                    b = function N() {
                                        for (; ++c < a.length;)
                                            if (w.call(a, c)) return N.value = a[c], N.done = !1, N;
                                        N.value =
                                            x;
                                        N.done = !0;
                                        return N
                        ...
                        if (F) v && (a.exports = F);
                            ...
                            (v = (v = Object.getPrototypeOf) &&
                                v(v(ea([])))) && v !== z && w.call(v, y) && (d = v);
                            var O = q.prototype = l.prototype = Object.create(d);
                            k.prototype = O.constructor = q;
                            q.constructor = k;
                            q[E] = k.displayName = "GeneratorFunction";
                            F.isGeneratorFunction = function (a) {
                                return (a = "function" === typeof a && a.constructor) ? a === k || "GeneratorFunction" === (a.displayName || a.name) : !1
                            };
                            F.mark = function (a) {
                                Object.setPrototypeOf ? Object.setPrototypeOf(a, q) : (a.__proto__ = q, E in a || (a[E] = "GeneratorFunction"));
                            ...
                            F.keys = function (a) {
                                ...
                                return function N() {
                                    for (; b.length;) {
                                        var c = b.pop();
                                        if (c in a) return N.value = c, N.done = !1, N
                                    }
                                    N.done = !0;
                                    return N
                                }
                            ...
                            A.prototype = {
                                ...
                                reset: function (a) {
                                    ...
                                    if (!a)
                                        for (var b in this) "t" === b.charAt(0) && w.call(this, b) && !isNaN(+b.slice(1)) && (this[b] = x)
                                },
                                stop: function () {
                                    this.done = !0;
                    ...
                    f = {
                        toChunks: function (a, b) {
                            var c = a.slice(0),
                                ...
                                l = 0;
                            return c.reduce(function (a, p, h) {
                                var e = f(b / (g / h));
    ...
    K.inherit = function (a) {
        ...
        a.constructor.inherit = K.inherit;
    ...
    var z = K.inherit({
        ...
        on: function (a, b, c, d, f) {
            ...
            for (m = 0; m < l; m++) {
                var r = b[m];
                var k = F(function (a) {
                    c.call(d || this, a || n.event)
                }, "on" + (r || "") + (f.name || ""));
                g[g.length] = [a, r, c, d, f, k];
                a.addEventListener ? a.addEventListener(r, k, z._prepOpts(f)) : a.attachEvent && a.attachEvent("on" + r, k)
            }
        },
        ...
        _removeListener: function (a,
            b, c, d) {
            a.removeEventListener ? a.removeEventListener(b, c, z._prepOpts(d)) : a.detachEvent && a.detachEvent("on" + b, c)
        }
    });
    z.supportsPassive = function () {
        if (z._supportsPassive !== x) return z._supportsPassive;
        z._supportsPassive = !1;
        try {
            var a = Object.defineProperty({}, "passive", {
                get: function () {
                    return z._supportsPassive = !0
                }
            });
            n.addEventListener("test", null, a)
        } catch (b) {}
        return z._supportsPassive
    };
    z._getOpts = function (a) {
        return k.mixin({
            capture: !0,
            passive: !0
        }, a || {})
    };
    z._prepOpts = function (a) {
        return z.supportsPassive() ?
            a : !!a.capture
    };
    z.on = function () {
        z._instance || (z._instance = new z);
        z._instance.on.apply(z._instance, arguments)
    };
    z.un = function () {
        z._instance && z._instance.un.apply(z._instance, arguments)
    };
    var y = {
        UNLOAD_MS: 0,
        isPerfomance: n.performance && n.performance.timing && n.performance.timing.navigationStart && n.performance.now,
        getMs: function () {
            return 0 < this.UNLOAD_MS ? this.UNLOAD_MS : this.isPerfomance ? Math.round(n.performance.timing.navigationStart + n.performance.now()) : y.oldMs()
        },
        getFormStart: function () {
            return this.isPerfomance ?
                Math.round(n.performance.now()) : this.getMs() - this.initTime
        }
    };
    y.oldMs = Date.now ? Date.now : function () {
        return (new Date).getTime()
    };
    y.initTime = y.getMs();
    z.on(n, "beforeunload,unload", function () {
        0 === y.UNLOAD_MS && (y.UNLOAD_MS = y.getMs())
    });
    k.pad = function (a) {
        return (10 > a ? "0" : "") + a
    };
    y.getTimestamp = function () {
        var a = new Date;
    ...
    y.isPerfomance || (y.deltaTime = 0, y.lastNowTime = 0, y.correctTime = 0, y.timeCorrector = function (a) {
        y.correctTime = y.getMs();
        a && y.correctTime < y.lastTime && (y.deltaTime += a - y.correctTime + 20);
        k.setTimeout(function () {
            y.timeCorrector(y.correctTime)
        }, 20, "timeCorrector")
    });
    y.initCorrector = function () {
        y.isPerfomance || y.timeCorrector(0)
    };
    y.nowTime = function () {
        if (this.isPerfomance) return this.getMs();
        var a = this.getMs() + y.deltaTime;
        a < y.lastNowTime && (a += y.lastNowTime + 10);
        return y.lastNowTime = a
    };
    y.nowEventTime = function () {
        return Math.round((y.nowTime() - y.initTime) / 50)
    };
    ...
    var Ua = K.inherit({
            ...
            _initComponent: function () {
                ...
                this._saveToStorageThrottled =
                    k.throttle(this._saveToStorage, 300, this, "DataBuffer._saveToStorage");
                this.storage && (a = this.storage.get(this.storageKey)) && a.data && a.meta && a.time && a.time + this.bufferExpireTime > +y.getMs() && this.onFlush.call(this.onFlushCtx || this, this.dataFromStorage(a.data), a.meta, a.pnum);
                this.clear()
            },
            ...
            updateStamp: function (a, b) {
                a.stamp !== x && (b.stamp = a.stamp, "eof" !==
                    a.type && delete a.stamp)
            },
            append: function (a, b) {
                this.mergeData(this._data, a);
                this._saveToStorageThrottled();
                this.active && ((b || this.getFlushSize() >= this.maxBufferSize || this.getFlushSize() === this.maxChunkSize) && this._flush(b), this._flushTID || (this._flushTID = k.defer(this._flush, this.flushTimeout, this, [b], "DataBuffer._flush")))
            },
            activate: function () {
    ...
    k.async = function (a, b, c) {
        if (n.postMessage) {
            var d = "__ym__promise" + Math.random() + "_" + y.getMs();
            var f = function (c) {
                try {
                    var g = c.data
                } catch (m) {
                ...
                g === d && (c.stopPropagation && c.stopPropagation(), a.call(b), z.un(n, "message", f, null, {
                    passive: !1
                }))
            };
            z.on(n, "message", f, null, {
                passive: !1,
                name: ".async." + (c || "")
            });
            n.postMessage(d, "*")
            ...
            send: function (a, b, c, d) {
                ...
                l.isDisabled() ? g.call(d) : function u(a) {
                    if (a < this.transports.length) try {
                        ...
                        (function h(p) {
                            p >= f.length ? c.blockNext() || u.call(this, a + 1) : c.request(f[p], b, function (a, b, c) {
                                a ? g.call(d, b, c) : k.async(function () {
                                    h.call(l, p + 1)
                                }, this, "senderCall")
                            }, this)
                        }).call(this, 0)
    ...
    Da.stringify = function (a, b) {
        var c = [],
            ...
            g, m;
        if (d.lastOrdering !== x)
            for (m = 1; m <= b.lastOrdering.length; m++) f[b.lastOrdering[m - 1]] = l + m;
        if (d.firstOrdering !== x)
            for (m = 0; m < b.firstOrdering.length; m++) f[b.firstOrdering[m]] = m;
        for (g in a)
            if (a.hasOwnProperty(g))
                if (d = a[g], k.isArray(d))
                    for (m = 0; m < d.length; m++) c.push({
                        key: g,
                        value: encodeURIComponent(g) + "\x3d" + encodeURIComponent(String(d[m]))
                    });
                else c.push({
                    key: g,
    ...
    var wa = K.inherit({
            ...
            _buildUrl: function (a, b) {
                var c =
                    Da.stringify(b, this.queryStringParams);
        ...
        Va = wa.inherit({
            ...
            request: function (a, b, c, d) {
                var f = this,
                    l;
                if (/[^a-z0-9.:-]/.test(L.host) && n.opera && "function" === typeof n.opera.version) {
                    var g = n.opera.version();
                ...
                if (n.XMLHttpRequest) {
                    ...
                    if ("withCredentials" in m) {
                        ...
                        m.onreadystatechange = function () {
                            if (4 === m.readyState) {
                                try {
                                    l = f._parseResp(m.responseText)
                                } catch (r) {
                                    return c.call(d, !1)
                                }
                                c.apply(d, [200 === m.status].concat(l))
                            }
                        };
                        this._timeOutCheck(m, c, d);
                        return
                    }
                }
                c.call(d, !1)
    ...
    var Wb = wa.inherit({
        ...
        index: 1,
        request: function (a, b, c, d) {
            "function" === typeof navigator.sendBeacon && !v.isAndroidWebView() && navigator.onLine ? (b = this._splitParams(b), b.get["force-urlencoded"] = 1, c.call(d, navigator.sendBeacon(this._buildUrl(a, b.get), Da.stringify(b.post)))) : c.call(d, !1)
        }
    });
    ...
    var Wa = wa.inherit({
            ...
            request: function (a, b, c, d) {
                ...
                g.style.top = "-99999px";
                var m = ['\x3ciframe name\x3d"', l, '"\x3e\x3c/iframe\x3e', '\x3cform action\x3d"', this._buildUrl(a, b.get), '" method\x3d"post" target\x3d"', l, '" enctype\x3d"', this.enctype, '"\x3e'];
    ...
    k.toJSON = function (a) {
        ...
        switch (a.constructor) {
            ...
            case Object:
                c = [];
                for (d in a) a.hasOwnProperty(d) && a[d] !== x && (c[c.length] = k.toJSON(d) + ":" + k.toJSON(a[d]));
                return "{" + c.join(",") + "}";
            default:
    ...
    var la = K.inherit({
        ...
        getStorageId: function () {
            var a = this.get("lsid");
            a || (a = Math.round(Math.random() * y.getMs()), this.set("lsid", a));
            return a
        },
    ...
    var na = {
            ...
            encode: function (a, b) {
                var c = (na.abc + (b ? na.tailSafe : na.tail)).split(""),
                    ...
                    g;
                for (g = 0; g < l; g += 3) {
                    var m = (a[g] << 16) + (a[g + 1] << 8) + a[g + 2];
                    k.mergeArrays(f, [c[m >> 18 & 63], c[m >> 12 & 63], c[m >> 6 & 63], c[m & 63]])
                }
                switch (d - l) {
                    case 1:
                        m = a[l] << 4;
                        k.mergeArrays(f, [c[m >> 6 & 63], c[m & 63], c[64], c[64]]);
                        break;
                    case 2:
                        m = (a[l] << 10) + (a[l + 1] << 2), k.mergeArrays(f,
                            [c[m >> 12 & 63], c[m >> 6 & 63], c[m & 63], c[64]])
                }
                return f.join("")
            },
            decode: function (a, b) {
                for (var c = na.abc + (b ? na.tailSafe : na.tail), d = 0, f = "", l, g, m, r, k; a.length % 4;) a += "\x3d";
                do {
                    l = c.indexOf(a.charAt(d++));
                    g = c.indexOf(a.charAt(d++));
                    r = c.indexOf(a.charAt(d++));
                    k = c.indexOf(a.charAt(d++));
                    if (0 > l || 0 > g || 0 > r || 0 > k) return null;
                    m = l << 18 | g << 12 | r << 6 | k;
                    l = m >> 16 & 255;
                    g = m >> 8 & 255;
                    m &= 255;
                    f = 64 == r ? f + String.fromCharCode(l) : 64 == k ? f + String.fromCharCode(l, g) : f + String.fromCharCode(l, g, m)
                } while (d < a.length);
                return f
            }
        },
    ...
    v.isFF = F(function (a) {
        var b = !1;
        n && n.document && n.document.documentElement && n.document.documentElement.style && (b = "MozAppearance" in n.document.documentElement.style &&
            "undefined" !== typeof n.InstallTrigger);
    ...
    var Ea = {
            ...
            genYm: function (a) {
                var b = this,
                    c = I(),
                    d = y.getMinutes();
                if (!this.checkVersion() && n.fetch && this._storage.get("retryReqs") && "yandex.ru" ==
                    c.hostname && "/" == c.pathname && !(a.lt && a.lt + 1440 > d)) {
                    a.lt = d;
                    ...
                    fetch("//" + f + "/daiku", {
                        ...
                        c && (a.resp = c._ym_uid, a.dmn = na.encode(Oa.encode(f)), b._storage.set(b.ymKey, a))
                    })["catch"](function () {
            ...
            initPU: function (a, b) {
                var c = this,
                    d = v.isFF(68);
                this.globalConfig = b;
                b.get("pu") !== x || this.checkVersion() && !d || (b.setSafe("pu", null), a.addHandler("gpu-get",
                    function () {
                        return {
                            type: "gpu-get",
                            pu: b.get("pu")
            ...
            onicecandidate: F(function (a) {
                ...
                c && 0 < c.length && (this.pp = k.fnv32a(c[1]), this.globalConfig.set("pp",
                    this.pp));
                a.onicecandidate = this.noop;
                a.close()
            }, "wrt"),
            ...
            initPP: F(function (a) {
                ...
                this.globalConfig = a;
                if (n.navigator.onLine && b && a.get("pp") == x && (this.globalConfig.setSafe("pp", null), b && b.prototype && b.prototype.constructor && b.prototype.constructor.name)) {
                    try {
                        var c = new b({
                            iceServers: []
                        });
            ...
            initZZ: function () {
                ...
                var b = v.isFF(68);
                var c = this;
                this.getZZ() || this.checkVersion() && !b || (b && (a = "md"), b = k.getNativeFunction("createElement", t)("iframe"), b.style.display = "none", b.style.width = "1px", b.style.height = "1px", b.style.visibility = "hidden", b.src = "https://mc.yandex." + a + na.decode("L21ldHJpa2EvenpsYy5odG1s"),
                    n.document.documentElement.appendChild(b), z.on(n, "message", this.onMessage, this, {
                        passive: !1
                    }), this.frame = b, this.timeout = k.setTimeout(function () {
                        z.un(n, "message", c.onMessage, c, {
                            passive: !1
                        });
            ...
            onMessage: function (a) {
                a.data && a.data.substr && "__ym__zz" === a.data.substr(0, 8) && (this.zz = a.data.substr(8), w.removeNode(this.frame), this._storage.set(this.key, this.zz), z.un(n, "message", this.onMessage, this, {
                    passive: !1
                }), clearTimeout(this.timeout))
            },
            fipKey: "fip",
            fpFactors: ["webGL",
                "plugins", "applePay", "dnt"
            ],
            initFip: function () {
                if (Object.keys && !this.checkVersion() && !this._storage.get(this.fipKey)) {
                    var a = new jb(k.reduce(function (a, c) {
                        a[c] = 1;
                        return a
                    }, {}, this.fpFactors));
                    a = a.toString(!1).join("-");
        ...
        R = Vb.inherit({
            ...
            counterType: 0,
            retry: !1,
            transports: [Wb, Va, pa, Xb],
            _initComponent: function () {
                R.superclass._initComponent.apply(this,
                    arguments);
                this.retry && (this._storage = new la)
            },
            send: function (a, b, c, d) {
            ...
            _sendSavedRequest: function (a, b, c, d, f) {
                ...
                if ("process" == l) this.globalConfig.set("firstReqCallbacks", k.mergeArrays(this.globalConfig.get("firstReqCallbacks") || [],
                    ...
                    c && (k.forEachKey(c, function (a, b) {
                        "t" != a && k.mergeArrays(m, [a, b])
                    }), c.t && k.mergeArrays(m,
                        ["t", c.t]));
                    m.length && (b["browser-info"] = m.join(":"));
                    return R.superclass.send.call(this, l, b, function () {
                        var b;
    ...
    R.retransmit = function (a) {
        ...
        k.forEachKey(c, function (b, c) {
            ...
            c.ghid && c.ghid != a.get("_globalMetrikaHitId") && c.time && c.time + 1728E5 > g && 500 < g - c.time && 2 >= c.browserInfo.rqnl && (d = new R({
                protocol: c.protocol,
                host: c.host,
                resource: c.resource,
    ...
    k.fletcher = function (a) {
        for (var b =
                a.length, c = 0, d = 255, f = 255, l, g, m; b;) {
            l = 21 < b ? 21 : b;
            b -= l;
            do g = "string" == typeof a ? a.charCodeAt(c) : a[c], c++, 255 < g && (m = g >> 8, g &= 255, g ^= m), d += g, f += d; while (--l);
            d = (d & 255) + (d >> 8);
            f = (f & 255) + (f >> 8)
        }
    ...
    k._hasIndexOf = [].indexOf && 0 === [x].indexOf(x);
    ...
    k.warning = function () {
        n.console && "function" === typeof n.console.warn && console.warn.apply(console,
            arguments)
    };
    ...
    v.getSilverlightVersion = k.memorize(function () {
        if (n.ActiveXObject) try {
            ...
            var c = function (a, b) {
                return a.isVersionSupported(b[0] +
                    "." + b[1] + "." + b[2] + "." + b[3])
            };
            var d = [1, 0, 0, 0];
            b(a, d, 0, 1);
            ...
            b(a, d, 3, 1);
            var f = d.join(".")
        } catch (l) {} else if (b = n.navigator, b = b.plugins && b.plugins["Silverlight Plug-In"]) f = b.description;
        return f || ""
    });
        ...
        if ("undefined" != typeof a.plugins && "object" == typeof a.plugins["Shockwave Flash"]) {
            ...
            if ((b = b.description) || c)
                if (a = a.mimeTypes, "undefined" ==
                    typeof a || !a["application/x-shockwave-flash"] || a["application/x-shockwave-flash"].enabledPlugin) c ? v._flashVersion = c : b && (v._flashVersion = b.replace(/([a-zA-Z]|\s)+/, "").replace(/(\s+r|\s+b[0-9]+)/, "."))
        } else if ("undefined" != typeof n.ActiveXObject) try {
            if (c = new ActiveXObject("ShockwaveFlash.ShockwaveFlash"), b = c.GetVariable("$version")) v._flashVersion = b.split(" ")[1].replace(/,/g, ".").replace(/[^.\d]/g, "")
        } catch (d) {}
        return v._flashVersion
    });
    v.getLanguage = k.memorize(function () {
        var a = (n.navigator ? navigator.language ||
            navigator.userLanguage || navigator.browserLanguage || navigator.systemLanguage : "").toLowerCase();
    ...
    v.getFingerPrint = k.memorize(function () {
        ...
        if (navigator.mimeTypes && navigator.mimeTypes.length)
            for (b = 0; b <
                navigator.mimeTypes.length; b++) c = navigator.mimeTypes[b], k.mergeArrays(a, [c.type, c.description, c.suffixes]);
    ...
    v.isDesktop = function (a) {
        var b = a.get("bt", {});
        a.get("bt") === x && (b.p = navigator.getBattery ? navigator.getBattery() : null, a.set("bt", b), b.p && b.p.then && b.p.then(function (a) {
    ...
    var yb = {
        ...
        _send: function () {
            ...
            z.ready(function () {
                ...
                v.isSafari() && (b.style.position = "absolute", b.style.visibility = "hidden", b.style.width = "0px", b.style.height = "0px", w.getRootElement().appendChild(b))
            })
        },
        _saveReq: function (a) {
            this._value = a = a ? "1" : "2";
    ...
    var Pa = R.inherit({
            ...
            _reduce: function (a) {
                return function (b, c) {
                    k.arrayEvery(k.keys(c), function (d) {
                        if (b.hasOwnProperty(d)) return 1; - 1 == k.arrayIndexOf(a, d) &&
                            (b[d] = c[d], delete c[d]);
                        return 1
                    });
                    return b
        ...
        sendTitle: !0,
        _initComponent: function () {
            Pa.superclass._initComponent.apply(this,
                arguments);
        ...
        sendGoal: function (a, b) {
            if (/[/&=?#]/.test(a)) k.warning("Incorrect goal");
                ...
                var c = b.url ? k.parseUrl(b.url) : I();
                this._hitExt({
        ...
        _hitExt: function (a,
            ...
            if (!k.isMetrikaPlayer()) {
                var m = a.modes || {};
                var r = a.browserInfo || {};
                var u = "undefined" !== typeof a.referrer ? a.referrer : Xa.lastReferrer;
                var q = a.url || "";
                var n = {};
                a.nohit && c("nohit", 1);
                m.ar && !m.onlyData && (u = null === u || "" === u ? "" : this._prepareHitUrl(u), q = this._prepareHitUrl(a.url));
                c("forceNoRedirect", a.forceNoRedirect);
                c("page-ref", k.trim(u, lb));
                c("page-url", k.trim(q, lb));
                k.is4Bytes(a.title) && c("charset", "utf-8"); - 1 != I().hostname.search(/(?:^|\.)(?:ya|yandex)\.(?:\w+|com?\.\w+)$/) ?
                    c("ut", kb) : "undefined" != typeof m.ut && c("ut", k.trim(m.ut, Yb));
                c("exp", a.experiments);
                (f = a.vParams) && this.counter && f.__ym && (k.isNumber(f.__ym.turbo_page) && (this.counter.tp = f.__ym.turbo_page), k.isNumber(f.__ym.turbo_page_id) && (this.counter.tpid = f.__ym.turbo_page_id));
                (!f || k.isObject(f) && !f.__ym && !f.__ymu) && this.paramsQueue.length() && k.inArray(["go", "hit", "pa"], b) && (f = this.paramsQueue.mixin(f));
                f && (q = k.toJSON(f), this.trimParams && q.length > Zb ? l = !0 : 7E5 < q ? k.warning("Too big params") : c("site-info", q));
                m.saveRef &&
                    (Xa.lastReferrer = u);
                g = function (a, b) {
                    var c = {};
                    k.forEachKey(b, function (a, b) {
                        -1 === k.arrayIndexOf(["", 0, x, null], b) && (c[a] = b)
                    });
                    return k.mixin({}, a, c)
                }(g, {
                ...
                this.fake || (d = this._getTechInfo(a.title, m, this.counterId, a.ts, a.tz, this._trackHash, this.hitId, this.webvisor, this.counter, a.nohit));
                g.wv =
                    2;
                k.mixin(r, d, g);
                this.send(n, r, function () {
        ...
        _getTechInfo: function (a, b, c, d, f, l, g, m, r, u) {
            function q(a, b, c) {
                var e = "" + b;
                a && b && (c || -1 === e.indexOf(":")) && (p[a] = e)
            }
            ...
            d = d || y.getTimestamp();
            f = f || y.getTimezone();
            q("j", v.getJavaEnabled() ? "1" : "");
            var h = v.isDesktop(this.globalConfig);
            h !== x &&
                q("dp", h ? "1" : "0");
            q("nt", v.netType());
            q("ns", v.getNavigationStart());
            ka && q("s", ka.width + "x" + ka.height + "x" + (ka.colorDepth || ka.pixelDepth));
            n.devicePixelRatio && q("sk", n.devicePixelRatio);
            v.isSelenium() && q("iss", "1");
            v.isHeadLess() && q("hdl", "1");
            v.isIframe() && (q("ifr", "1"), q("sti", v.isSameOriginTopFrame() ? "1" : "0"));
            n.ia_document && n.ia_document.shareURL && n.ia_document.referrer && q("iia", "1");
            q("adb", yb.getVal());
            q("f", v.getFlashVersion());
            q("l", v.getSilverlightVersion());
            q("fpr", v.getFingerPrint());
            q("cn",
                this.counterNum);
            b.pa || (h = w.getViewportSize(), q("w", h[0] + "x" + h[1]));
            q("z", f);
            q("i", d);
            q("et", y.getSeconds());
            q("en", w.getDocumentCharset());
            q("c", navigator.cookieEnabled ? "1" : "");
            q("la", v.getLanguage());
            q("ntf", v.getNotificationPermission());
            k.random(100) || q("np", na.encode(Oa.encode(k.trim(v.getPlatform(), 100))));
            l && q("wh", "1");
            f = "ar ln re dl cpf ad nb pa pq pv ex".split(" ");
            for (d = 0; d < f.length; d++) C(f[d]);
            f = "va vt sn sa he pai".split(" ");
            b.nb && f.push("cl");
            for (d = 0; d < f.length; d++) l = f[d], q(l, b[l]);
            f = new la({
                counterId: c
            });
            f.isEnabled() && (c = f.getStorageId(), d = f.get("reqNum"), u || (d ? d++ : d = 1), f.set("reqNum", d), f.get("reqNum") == d ? (q("ls", c), q("rqn", d)) : (f.remove("reqNum"), f.clearStorageId(), 1 < d && (q("ls", c), q("rqn", 0))));
            q("rn", k.random());
            q("hid", g);
            u || 3 == this.counterId || b.pq || q("ds", Rb(r));
            r._firstPaint || u || (r._firstPaint = Tb(), q("fp", r._firstPaint));
            if (m) {
                g = D.get("winNameNum");
                if (!g) {
                    if (g = +n.name || Math.round(65535 * Math.random())) 0 > g && (g *= -1), g %= 65535;
                    g = g || k.fletcher(n.name);
                    D.set("winNameNum", g)
                }
                q("wn",
                    g);
                try {
                    n.history && q("hl", String(n.history.length))
                } catch (e) {}
            }
            g = "";
        ...
        _getTitle: function (a) {
            a = "undefined" == typeof a ? (a = w.getDocumentTitle()) ? k.trim(a, zb) : "" : k.trim(a, zb);
            return a
        }
    });
    ...
    var Ra = K.inherit({
        ...
        $b = R.inherit({
            ...
            retry: !0,
            postParams: ["wv-data"],
            sendPacket: function (a, b, c, d, f, l, g, m) {
                if (!a || !a.length) return !1;
                var r = na.encode(a, !0);
                if (0 == r.indexOf("AAAAAAAAADw") && n.Error) {
                    var u = Error();
    ...
    w.getElementChildren = function (a, b) {
        ...
        if (a && (d = a.childNodes)) {
            ...
            for (l = d.length; g < l; g++) {
                var m = d[g];
                (f = "INPUT" == m.nodeName && m.type && "hidden" == m.type.toLocaleLowerCase()) || b && m.nodeName != b || k.mergeArrays(c, [m])
            }
        }
        return c
    };
    ...
    w.getDocumentScroll = function () {
        var a = w.getBody();
        return [n.pageXOffset || t.documentElement && t.documentElement.scrollLeft || a && a.scrollLeft || 0, n.pageYOffset || t.documentElement && t.documentElement.scrollTop || a && a.scrollTop || 0]
    };
            ...
            var jb = function (a) {
                ...
                var d = this && this.U || function () {
                    return (d = Object.assign || function (a) {
                        for (var b, c = 1, d = arguments.length; c < d; c++)
                            for (var h in b = arguments[c]) Object.prototype.hasOwnProperty.call(b,
                                h) && (a[h] = b[h]);
                        return a
                ...
                var d = function (a) {
                    ...
                    return c(b, a), b.prototype.J = function () {
                        ...
                        try {
                            ...
                            p && (b.push("webgl unmasked vendor:" + a.getParameter(p.UNMASKED_VENDOR_WEBGL)), b.push("webgl unmasked renderer:" +
                                a.getParameter(p.UNMASKED_RENDERER_WEBGL)))
                        } catch (h) {}
                ...
                b.hash = function (a, b) {
                    ...
                    var m = (a = a || "").length % 16,
                        ...
                        p = [0, b];
                    b = [0, b];
                    for (var h, e, B = [2277735313, 289559509], H = [1291169091, 658871167], A = 0; A < r; A += 16) h = [255 & a.charCodeAt(A + 4) | (255 & a.charCodeAt(A + 5)) << 8 | (255 & a.charCodeAt(A + 6)) << 16 | (255 & a.charCodeAt(A + 7)) << 24, 255 & a.charCodeAt(A) | (255 & a.charCodeAt(A + 1)) << 8 | (255 & a.charCodeAt(A + 2)) << 16 | (255 & a.charCodeAt(A + 3)) << 24], e = [255 & a.charCodeAt(A + 12) | (255 & a.charCodeAt(A + 13)) << 8 | (255 & a.charCodeAt(A + 14)) << 16 | (255 & a.charCodeAt(A + 15)) << 24, 255 & a.charCodeAt(A + 8) | (255 & a.charCodeAt(A + 9)) << 8 | (255 & a.charCodeAt(A + 10)) << 16 | (255 & a.charCodeAt(A +
                        11)) << 24], h = f(h = c(h, B), 31), p = d(p = f(p = g(p, c(h, H)), 27), b), p = d(c(p, [0, 5]), [0, 1390208809]), e = f(e = c(e, H), 33), b = d(b = f(b = g(b, c(e, B)), 31), p), b = d(c(b, [0, 5]), [0, 944331445]);
                    switch (h = [0, 0], e = [0, 0], m) {
                        case 15:
                        ...
                        case 9:
                            e = c(e = g(e, [0, a.charCodeAt(A + 8)]), H), b = g(b, c(f(e,
                                33), B));
                        case 8:
                        ...
                        case 1:
                            h = c(h = g(h, [0, a.charCodeAt(A)]), B), p = g(p, c(f(h, 31), H))
                    }
                    return p = d(p = g(p, [0, a.length]), b = g(b, [0, a.length])), b = d(b, p), p = d(p = k(p), b = k(b)), b = d(b, p), ("00000000" + (p[0] >>> 0).toString(16)).slice(-8) + ("00000000" +
                        (p[1] >>> 0).toString(16)).slice(-8) + ("00000000" + (b[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (b[1] >>> 0).toString(16)).slice(-8)
                }
            }]);
            jb = jb["default"]
        }
    ...
    var mb = {
            ...
            addAsyncItem: function (a, b, c, d, f) {
                ...
                c ? (clearTimeout(this.timeout), l.flushAsync(!0)) : y.getMs() - this.rest >= this.restTime && !this.timeout ? (this.rest = y.getMs(), l.flushAsync()) : this.timeout || (this.timeout = k.setTimeout(function () {
                    l.rest = y.getMs();
                    l.flushAsync();
                    l.timeout = !1
                }, this.restTime))
            ...
            callByTimeout: function (a, b) {
                for (var c = y.getMs(), d = 0, f, l = (b || 0) + 1, g = 0, m = this; this.asyncBuffer.length;)
                    if (f = this.asyncBuffer.shift(), g += 1, !f.isExecuted && (F(function () {
                            f.fn.apply(f.ctx, f.args)
                        }, "AsyncExecutor." + f.loggerName)(), d = y.getMs() - c, f.isExecuted = !0, !a && (g >= this.asyncChunk || d >= this.maxDuration))) {
                        k.setTimeout(function () {
                            m.callByTimeout(a, l)
                        }, this.restTime);
                        break
        ...
        ac = Va.inherit({
            ...
            _splitParams: function (a) {
                var b = {},
                    c = {};
                k.forEachKey(a, function (a, f) {
                    k.inArray(this.postParams, a) ? this.postParams.isSingle ? c = f : c[a] = f : b[a] = f
                }, this);
                return {
                    get: b,
                    post: c
        ...
        nb = R.inherit({
            ...
            transports: [ac],
            _initComponent: function () {
                nb.superclass._initComponent.apply(this,
                    arguments);
                this.postParams.isSingle = !0
            },
            sendPacket: function (a, b, c, d, f, l, g, m, r) {
        ...
        Za = Ua.inherit({
            ...
            append: function (a) {
                !this._data.length && a && a.length && (this.startBufferTime = y.getSeconds());
                Za.superclass.append.apply(this, arguments)
            },
            _getSize: function (a) {
                var b = this;
                this.chunkSize +=
                    encodeURIComponent(a).length;
                ...
                if (!this.totalSendLimit || this._totalSendedSize < this.totalSendLimit)
                    if (this._v = c, this.wrappers.length && k.arrayEvery(this.wrappers, function (c) {
                        ...
                        if (f > this.maxBufferSize)
                            for (this._data.length && this._flush(), d = Math.ceil(f / r); l < c.length;) m.partNum = g, m.end = g === d, m.data = c.slice(l, l += r), g++, this._getSize(m.data), this.append([m], !0);
                        else m.data = c, this.append([m], d);
                        this.store.set(m, {
                            id: a,
                            data: b
                        })
    ...
    try {
        J = function (a) {
            ...
            return b(b.s = 18)
                ...
                function d(a, b, c) {
                    for (var d = Object.keys(b), g = 0; g < d.length; ++g) void 0 !== a[d[g]] && c || (a[d[g]] = b[d[g]]);
                    return a
                }
                ...
                b.newBuffer = function (a) {
                    return "number" == typeof a ? b.Buffer ? b._Buffer_allocUnsafe(a) : new b.Array(a) : b.Buffer ? b._Buffer_from(a) : "undefined" ==
                        typeof Uint8Array ? a : new Uint8Array(a)
                };
                ...
                function k() {
                    ...
                    return new q(g(this.buf, this.pos += 4), g(this.buf, this.pos += 4))
                }
                a.exports = f;
                var r, u = c(0),
                    q = u.LongBits,
                    n = u.utf8,
                    p, h = "undefined" != typeof Uint8Array ? function (a) {
                ...
                f.create = u.Buffer ? function (a) {
                    return (f.create = function (a) {
                        return u.Buffer.isBuffer(a) ? new r(a) : h(a)
                    })(a)
                } : h;
                f.prototype._slice = u.Array.prototype.subarray || u.Array.prototype.slice;
                f.prototype.uint32 = (p = 4294967295, function () {
                    p = (127 & this.buf[this.pos]) >>> 0;
                    if (128 > this.buf[this.pos++]) return p;
            ...
            function (a, b, c) {
                ...
                g.alloc = function (a) {
                    return new p.Array(a)
                };
                p.Array !== Array && (g.alloc = p.pool(g.alloc, p.Array.prototype.subarray));
                ...
                g.prototype.uint32 = function (a) {
                    this.len += (this.tail = this.tail.next = new r(128 > (a >>>= 0) ? 1 : 16384 > a ? 2 : 2097152 > a ? 3 : 268435456 > a ? 4 : 5, a)).len;
                    return this
                };
                g.prototype.int32 = function (a) {
                    return 0 > a ? this._push(u, 10, h.fromNumber(a)) : this.uint32(a)
                };
                ...
                g.prototype.fixed32 = function (a) {
                    return this._push(q, 4, a >>> 0)
                };
                g.prototype.sfixed32 = g.prototype.fixed32;
                g.prototype.fixed64 = function (a) {
                    a = h.from(a);
                    return this._push(q, 4, a.lo)._push(q, 4, a.hi)
                };
                g.prototype.sfixed64 = g.prototype.fixed64;
                g.prototype["float"] = function (a) {
                    return this._push(p["float"].writeFloatLE, 4, a)
                };
                g.prototype["double"] = function (a) {
                    return this._push(p["float"].writeDoubleLE, 8, a)
                };
                var H = p.Array.prototype.set ?
                    function (a, b, c) {
                        b.set(a, c)
                    } : function (a, b, c) {
                ...
                g.prototype.reset =
                    function () {
                        this.states ? (this.head = this.states.head, this.tail = this.states.tail, this.len = this.states.len, this.states = this.states.next) : (this.head = this.tail = new d(f, 0, 0), this.len = 0);
                        return this
                    };
            ...
            function (a, b, c) {
                ...
                d.prototype.rpcCall = function C(a, b, c, d, k) {
                    ...
                    if (g.rpcImpl) try {
                        return g.rpcImpl(a,
                            b[g.requestDelimited ? "encodeDelimited" : "encode"](d).finish(),
                            function (b, e) {
            ...
            function (a, b, c) {
                ...
                var l = c(2);
                (d.prototype =
                    Object.create(l.prototype)).constructor = d;
                var g = c(0),
                    k = g.Buffer;
                d.alloc = function (a) {
                    return (d.alloc = g._Buffer_allocUnsafe)(a)
                };
                var r = k && k.prototype instanceof Uint8Array && "set" === k.prototype.set.name ? function (a, b, c) {
                    b.set(a, c)
                } : function (a, b, c) {
            ...
            function (a, b, c) {
                ...
                d.fromHash = function (a) {
                    return a === g ? l : new d((k.call(a, 0) | k.call(a, 1) << 8 | k.call(a, 2) << 16 | k.call(a, 3) << 24) >>> 0, (k.call(a, 4) | k.call(a, 5) << 8 | k.call(a, 6) << 16 | k.call(a, 7) << 24) >>> 0)
                };
            ...
            function (a, b, c) {
                b.length = function (a) {
                    for (var b = 0, c, d = 0; d < a.length; ++d) c = a.charCodeAt(d), 128 > c ? b += 1 : 2048 > c ? b += 2 : 55296 == (64512 & c) && 56320 == (64512 & a.charCodeAt(d + 1)) ? (++d, b += 4) : b += 3;
                    return b
                };
                b.read = function (a, b, c) {
                    ...
                    return f ? (k && f.push(String.fromCharCode.apply(String, l.slice(0, k))), f.join("")) : String.fromCharCode.apply(String, l.slice(0, k))
                };
            ...
            function (a, b, c) {
                function d(a) {
                    ...
                    "undefined" != typeof Float64Array ? function () {
                        ...
                        function b(a, b, c, e, d, f) {
                            var h = 0 > e ? 1 : 0;
                            h && (e = -e);
                            if (0 === e) a(0, d, f + b), a(0 < 1 / e ? 0 : 2147483648,
                                d, f + c);
                        ...
                        function c(a, b, c, e, d) {
                            ...
                            return 2047 ===
                                c ? b ? NaN : 1 / 0 * a : 0 === c ? 5e-324 * a * b : a * Math.pow(2, c - 1075) * (b + 4503599627370496)
                        }
                ...
                function m(a, b) {
                    return (a[b] << 24 | a[b + 1] << 16 | a[b + 2] << 8 | a[b +
                        3]) >>> 0
                }
                a.exports = d(d)
            },
            ...
            function (a, b, c) {
                ...
                b.encode = function (a, b, c) {
                    for (var f, g = null, k = [], l = 0, p = 0; b < c;) {
                        var h = a[b++];
                        switch (p) {
                            case 0:
                                k[l++] = d[h >> 2];
                    ...
                    p && (k[l++] = d[f], k[l++] = 61, 1 === p && (k[l++] = 61));
                    return g ? (l && g.push(String.fromCharCode.apply(String, k.slice(0, l))), g.join("")) : String.fromCharCode.apply(String, k.slice(0, l))
                };
                b.decode = function (a, b, c) {
                    for (var d, g = c, k = 0, l = 0; l < a.length;) {
                        var p = a.charCodeAt(l++);
                        if (61 === p && 1 < k) break;
                        if (void 0 === (p = f[p])) throw Error("invalid encoding");
                        switch (k) {
                            case 0:
                                d = p;
                                k = 1;
                                ...
                                a.proto = function () {
                                    ...
                                    a.Buffer = function () {
                                        ...
                                        a.encode = function (a, b) {
                                            ...
                                            null != a.chunk && Object.hasOwnProperty.call(a, "chunk") &&
                                                b.uint32(34).bytes(a.chunk);
                                            null != a.end && Object.hasOwnProperty.call(a, "end") && b.uint32(40).bool(a.end);
                                            return b
                                        };
                                        a.decode = function (a, b) {
                                            a instanceof d || (a = d.create(a));
                                            for (var c = void 0 === b ? a.len : a.pos + b, e = new g.ru.yandex.metrika.wv2.proto.Buffer; a.pos < c;) {
                                                var h = a.uint32();
                                                switch (h >>> 3) {
                                                    case 1:
                                                        e.stamp = a.int32();
                                    ...
                                    a.Wrapper = function () {
                                        ...
                                        a.encode = function (a, b) {
                                            ...
                                            null != a.mutation && Object.hasOwnProperty.call(a, "mutation") && g.ru.yandex.metrika.wv2.proto.Mutation.encode(a.mutation, b.uint32(18).fork()).ldelim();
                                            ...
                                            null != a.articleInfo && Object.hasOwnProperty.call(a,
                                                "articleInfo") && g.ru.yandex.metrika.wv2.proto.ArticleInfo.encode(a.articleInfo, b.uint32(34).fork()).ldelim();
                                            null != a.publishersHeader && Object.hasOwnProperty.call(a, "publishersHeader") && g.ru.yandex.metrika.wv2.proto.PublishersHeader.encode(a.publishersHeader, b.uint32(42).fork()).ldelim();
                                            null != a.activity && Object.hasOwnProperty.call(a, "activity") && b.uint32(48).uint32(a.activity);
                                            return b
                                        };
                                        a.decode = function (a, b) {
                                            a instanceof d || (a = d.create(a));
                                            for (var c = void 0 === b ? a.len : a.pos + b, e = new g.ru.yandex.metrika.wv2.proto.Wrapper; a.pos <
                                                c;) {
                                                var h = a.uint32();
                                                switch (h >>> 3) {
                                                    case 1:
                                                    ...
                                                    case 2:
                                                        ...
                                                        break;
                                                    case 3:
                                                        e.event = g.ru.yandex.metrika.wv2.proto.Event.decode(a, a.uint32());
                                                        break;
                                                    case 4:
                                    ...
                                    a.Page = function () {
                                            ...
                                            for (var c = void 0 === b ? a.len : a.pos + b, e = new g.ru.yandex.metrika.wv2.proto.Page; a.pos < c;) {
                                                ...
                                                switch (h >>> 3) {
                                                    ...
                                                    case 2:
                                                        ...
                                                        e.content.push(g.ru.yandex.metrika.wv2.proto.Page.Content.decode(a, a.uint32()));
                                                        break;
                                                    case 3:
                                                        e.frameId = a.sint32();
                                                        break;
                                        ...
                                        a.Box = function () {
                                            ...
                                            a.decode = function (a, b) {
                                                a instanceof d || (a = d.create(a));
                                                for (var c = void 0 === b ? a.len : a.pos + b, e = new g.ru.yandex.metrika.wv2.proto.Page.Box; a.pos <
                                                    c;) {
                                                    var h = a.uint32();
                                                    switch (h >>> 3) {
                                                        case 1:
                                        ...
                                        a.Location = function () {
                                            ...
                                            a.encode = function (a, b) {
                                                ...
                                                null != a.protocol &&
                                                    Object.hasOwnProperty.call(a, "protocol") && b.uint32(18).string(a.protocol);
                                                null != a.path && Object.hasOwnProperty.call(a, "path") && b.uint32(26).string(a.path);
                                                return b
                                            };
                                            a.decode = function (a, b) {
                                                a instanceof d || (a = d.create(a));
                                                for (var c = void 0 === b ? a.len : a.pos + b, e = new g.ru.yandex.metrika.wv2.proto.Page.Location; a.pos < c;) {
                                                    var h = a.uint32();
                                                    switch (h >>> 3) {
                                                        case 1:
                                                            e.host = a.string();
                                        ...
                                        a.Scroll = function () {
                                            ...
                                            a.decode = function (a, b) {
                                                a instanceof d || (a = d.create(a));
                                                for (var c =
                                                        void 0 === b ? a.len : a.pos + b, e = new g.ru.yandex.metrika.wv2.proto.Page.Scroll; a.pos < c;) {
                                                    var h = a.uint32();
                                                    switch (h >>> 3) {
                                                        case 1:
                                                            e.target = a.int32();
                                        ...
                                        a.Meta = function () {
                                            ...
                                            a.encode = function (a, b) {
                                                ...
                                                null !=
                                                    a.address && Object.hasOwnProperty.call(a, "address") && b.uint32(26).string(a.address);
                                                ...
                                                null != a.screen && Object.hasOwnProperty.call(a, "screen") && g.ru.yandex.metrika.wv2.proto.Page.Box.encode(a.screen,
                                                ...
                                                null != a.location && Object.hasOwnProperty.call(a, "location") && g.ru.yandex.metrika.wv2.proto.Page.Location.encode(a.location, b.uint32(82).fork()).ldelim();
                                            ...
                                            a.decode = function (a, b) {
                                                ...
                                                for (var c = void 0 === b ? a.len : a.pos + b, e = new g.ru.yandex.metrika.wv2.proto.Page.Meta; a.pos < c;) {
                                                    ...
                                                    switch (h >>> 3) {
                                                        ...
                                                        case 9:
                                                            e.viewport =
                                                                g.ru.yandex.metrika.wv2.proto.Page.Box.decode(a, a.uint32());
                                                            break;
                                                        case 10:
                                                        ...
                                                        case 11:
                                                            ...
                                                            e.initialScroll.push(g.ru.yandex.metrika.wv2.proto.Page.Scroll.decode(a, a.uint32()));
                                                            break;
                                                        default:
                                                            a.skipType(7 & h)
                                                    }
                                        ...
                                        a.Content = function () {
                                            ...
                                            a.encode = function (a, b) {
                                                ...
                                                if (null != a.attributes && Object.hasOwnProperty.call(a, "attributes"))
                                                    for (var c = Object.keys(a.attributes),
                                                            e = 0; e < c.length; ++e) b.uint32(26).fork().uint32(10).string(c[e]).uint32(18).string(a.attributes[c[e]]).ldelim();
                                    ...
                                    a.Mutation = function () {
                                            ...
                                            for (var c = void 0 === b ? a.len : a.pos + b, e = new g.ru.yandex.metrika.wv2.proto.Mutation; a.pos < c;) {
                                                ...
                                                switch (h >>> 3) {
                                                    ...
                                                    case 2:
                                                        ...
                                                        break;
                                                    case 3:
                                                        e.meta = g.ru.yandex.metrika.wv2.proto.Mutation.Meta.decode(a,
                                                            a.uint32());
                                                        break;
                                                    case 4:
                                                        e.frameId = a.sint32();
                                        ...
                                        a.AttributeChange = function () {
                                            ...
                                            a.encode = function (a, b) {
                                                ...
                                                null != a.id && Object.hasOwnProperty.call(a, "id") && b.uint32(8).int32(a.id);
                                                if (null != a.at && Object.hasOwnProperty.call(a, "at"))
                                                    for (var c = Object.keys(a.at), d = 0; d < c.length; ++d) b.uint32(18).fork().uint32(10).string(c[d]),
                                                        g.ru.yandex.metrika.wv2.proto.Mutation.BeforeAfter.encode(a.at[c[d]], b.uint32(18).fork()).ldelim().ldelim();
                                            ...
                                            a.decode = function (a, b) {
                                                ...
                                                for (var c, e = void 0 === b ? a.len : a.pos + b, h = new g.ru.yandex.metrika.wv2.proto.Mutation.AttributeChange; a.pos < e;) switch (c = a.uint32(), c >>> 3) {
                                                    ...
                                                    case 2:
                                                        ...
                                                        c = a.string();
                                                        a.pos++;
                                                        h.at[c] = g.ru.yandex.metrika.wv2.proto.Mutation.BeforeAfter.decode(a,
                                                            a.uint32());
                                                        break;
                                                    case 3:
                                                        h.i = a.int32();
                                        ...
                                        a.TextChange = function () {
                                            ...
                                            a.encode = function (a, b) {
                                                b || (b = f.create());
                                                null != a.id && Object.hasOwnProperty.call(a, "id") && b.uint32(8).int32(a.id);
                                                null != a.ct && Object.hasOwnProperty.call(a, "ct") && g.ru.yandex.metrika.wv2.proto.Mutation.BeforeAfter.encode(a.ct,
        ...
        var $a = {
            ...
            cc = {
                ...
                serializeBuffer: function (a, b, c) {
                    ...
                    b || (d.data = a);
                    c !== x && (d.stamp = c);
                    b && b.stamp === x && (d.stamp = y.getFormStart());
                    return d
                },
                ...
                serialize: function (a, b, c) {
                    var d = {},
                        f = {},
                        k = this[a + "Serialize"];
                    if (k) d[a] = k.call(this, b), f = new J.Wrapper(d);
                    else if (c && J.Wrapper.prototype[a] !== x) f[a] = b;
    ...
    var Bb = Ua.inherit({
            ...
            sendEncoded: function (a, b, c, d, f) {
                ...
                if (k > this.maxBufferSize) {
                    for (g = Math.ceil(k / this.maxChunkSize); n < k;) {
                        b.page = u;
                        b.end = u === g;
                    ...
                    this._totalSendedSize += n
                } else c = this.serializer.serializeBuffer(c,
                    null, b.stamp), this._totalSendedSize += k, this.store.set(c, f), this.append(c, d)
            },
            addData: function (a, b, c, d, f) {
                var l = {
                    type: a
                ...
                if (!this.totalSendLimit || this._totalSendedSize < this.totalSendLimit)
                    if (this._v = c, this.wrappers.length && k.arrayEvery(this.wrappers, function (c) {
                        ...
                        this.append(g, d)
                    } else this._data && 0 == this._data.buffer.length && (this.startBufferTime = y.getSeconds()), this.updateStamp(b, l), g = this.serializer.serialize(a,
                        b), d ? (c = this.serializer.toTransport(g, "Wrapper"), this.sendEncoded(c, l, g, !0, {
                        id: a,
                        data: b
            ...
            onFlush: function (a, b, c, d) {
                ...
                a && (this.wrappers.length && (k.arrayEvery(this.wrappers, function (b) {
                    ...
                    d ? this._sender.sendPacket(this.serializer.toTransport(a), b.url, b.hitId, c, b.timezone, b.timestamp, this.startBufferTime) : this.serializer.toTransport(a, "BufferWrapper", function (a) {
    ...
    S._check = F(function () {
        return -1 < n.location.href.indexOf("_ym_debug\x3d1") ||
            n._ym_debug || "1" === S._cookie.read("debug")
    });
    S.enabled = S._check();
    S.log = F(function () {
        (-1 < L.href.indexOf("_ym_debug\x3d1") || n._ym_debug) && this._cookie.create("debug", "1");
        n.console && console.log && this._check() && (S.enabled = !0, console.log.apply(console, arguments))
    }, "DebugConsole.log");
    var dc = K.inherit({
        eventMap: {
            mousemove: {
    ...
    w.closest = function (a, b) {
        var c;
        if (!(n && n.Element && n.Element.prototype)) return null;
        if (n.Element.prototype.closest && k.isNativeFunction(n.Element.prototype.closest, "closest")) return a.closest(b);
        ...
        if (n.document.querySelectorAll && k.isNativeFunction(n.Element.prototype.querySelectorAll, "querySelectorAll")) {
            var d = (n.document || n.ownerDocument).querySelectorAll(b);
            do
    ...
    var E = {
        ...
        ob = K.inherit({
            ...
            _postprocessData: function (a,
                b) {
                var c = this._getContentNode(b);
                a.pageTitle || (a.pageTitle = this._getTitleFromContent(c));
                a.pageUrlCanonical || (a.pageUrlCanonical = E.looksLikeFullUrl(a.id) ? a.id : this.getPageUrlCanonical());
            ...
            findContent: function () {
                var a, b = [],
                    c, d = this._findContentDescriptionNodes();
                for (a = 0; a < d.length; a++)
                    if (c = this._getContentData({
                            element: d[a]
                        })) k.isArray(c) || (c = [c]), k.map(function (a) {
                        a && (a = k.mixin({
                            sended: !1,
                            involvedTime: 0
                        }, a), a.index = b.push(a))
        ...
        ab = ob.inherit({
            ...
            fields: {
                ...
                chars: function (a) {
                    var b = 0;
                    a = a.element;
                    var c, d, f = "articleBody reviewBody recipeInstructions acceptedAnswer description text".split(" ");
                    for (c = 0; c < f.length; c++)
                ...
                rubric: function (a) {
                    ...
                    a && (a = E.selectProp(a, "itemListElement"), b = k.map(function (a) {
                        return {
                ...
                updateDate: function (a) {
                    return (a =
                        E.selectPropOne(a.element, "dateModified")) ? E.getDate(a) : ""
                },
                ...
                pageTitle: function (a) {
                    var b = "";
                    a = a.element;
                    var c = E.selectPropOne(a, "headline");
                    c && (b += E.getVal(c));
                    (c = E.selectPropOne(a, "alternativeHeadline")) && (b += " " + E.getVal(c));
                    "" === b && ((c = E.selectPropOne(a, "name")) || (c = E.selectPropOne(a, "itemReviewed")),
                        c && (b += E.getVal(c)));
                    return b
                },
                authors: function (a) {
            ...
            _postprocessData: function (a,
                ...
                c = b.element;
                if (!a.id) {
                    if (c.getAttribute && (c = c.getAttribute("itemtype"), c.match(/Review|Question/))) {
                        var d = k.map(function (a) {
                            return a.name
                        }, a.authors).join(", ");
                        c && (a.pageTitle = d + ": " + a.pageTitle)
                    }
                    a.id = a.pageTitle
                }
        ...
        ya = ob.inherit({
            ...
            fields: {
                ...
                rubric: function (a) {
                    var b =
                        ...
                        c = [];
                    k.map(function (a) {
                        (a = aa.parse(a.innerText)) && (a["@graph"] ? k.map(function (a) {
                            "BreadcrumbList" === a["@type"] && c.push(a)
                        }, a["@graph"]) : "BreadcrumbList" === a["@type"] && c.push(a))
                    }, [a.element].concat(k.toArray(E.select(t.body === b ? t.documentElement : b, this.dataNodesSelector))));
            ...
            _getContentNode: function (a) {
                ...
                return d ? d : E.closest(b, "head") || 0 === f.innerText.length ? n.document.body : f
            },
            ...
            _getContentData: function (a) {
                var b = a.element,
                    c = this,
                    d = [];
                return a.data || (a.data = aa.parse(b.innerText), a.data && /schema\.org/.test(a.data["@context"])) ? k.isArray(a.data["@graph"]) ? k.map(function (a) {
                    if (!k.inArray(c.schemaEntities["schema.org"], a["@type"])) return null;
                    a = {
                        element: b,
                        data: a
                    };
                    return ya.superclass._getContentData.call(c, a)
                }, a.data["@graph"]) : "QAPage" === a.data["@type"] ? (a = {
                    element: b,
                    data: a.data.mainEntity || a.data.mainEntityOfPage
                }, d.push(ya.superclass._getContentData.call(c, a)), d) : k.inArray(this.schemaEntities["schema.org"],
                    a.data["@type"]) ? d = ya.superclass._getContentData.call(this, a) : null : null
            },
            _postprocessData: function (a, b) {
                ...
                return ya.superclass._postprocessData.call(this, a, b)
            },
            _findContentDescriptionNodes: function () {
                return E.select(n.document, this.dataNodesSelector)
            }
        }),
        Cb = ob.inherit({
            id: "o",
            ...
            _getEntityData: function (a) {
                var b, c, d = {},
                    f = this._getContentNode({
                        element: a
                    }),
                    l = E.select(a === t.head ? a : f, "meta[property]"),
                    g, m = new RegExp("^(og:)?((" + this.schemaEntities.opengraph.join("|") +
                        "):)?");
                if (l && l.length) k.map(function (a) {
                    try {
                        if (g = a.parentNode === f || a.parentNode === n.document.head) b = a.getAttribute("property").replace(m, ""), c = a.getAttribute("content"), d[b] ? k.isArray(d[b]) ? d[b].push(c) : d[b] = [d[b], c] : d[b] = c
                    } catch (u) {}
                }, l);
                else return null;
                return k.inArray(this.schemaEntities.opengraph, d.type) ? {
                    data: d,
                    element: a
                } : null
            },
            ...
            _getContentData: function (a) {
                return (a = this._getEntityData(a.element)) ? Cb.superclass._getContentData.call(this,
                    a) : null
            }
        }),
        ec = K.inherit({
            ...
            isRemovedFromDoc: function (a) {
                return w.closest(a, "html") !== n.document.documentElement
            },
            ...
            send: function () {
                ...
                a.length && (this.push({
                    articleInfo: a
                }), S.log("Publisher content info found:", a), k.arrayEvery(this.articles, function (a) {
                    a.sended = !0;
                    return 1
                }))
            },
            start: function (a) {
                ...
                }), this._schema = new this.schemas[a.schema], this._schema.root = this.root, S.log('Publishers analytics schema "' + a.schema + '"'), this.checkSize()) : this.stop()
            },
            push: function (a) {
        ...
        Db = K.inherit({
            ...
            _getBufferType: function () {
                ...
                if (!S.enabled && Ab) {
                    ...
                    b && n.Uint8Array && n.Uint8Array.prototype.slice && (a = Bb)
                }
                return a
            },
            _initComponent: F(function () {
                var a = this._getBufferType();
                this._localStorage = new la({
                    counterId: this.counterId
                });
                ...
                "b" !== d && (this._formRecorder = new Nb(this.protocol, this.counterId, this.counterType, this.hid, this.globalConfig), this._recorder.on("error",
                    function (a) {
                        ua(a.error, a.namespace)
                    }), this._activity = new dc);
            ...
            start: F(function (a, b) {
                ...
                if (this._recorder) {
                    ...
                    this._publisher && !this._publisher.isStopped && (this._eventsBuffer.wrappers.push(this._publisher),
                        this._eventsBuffer.setWVType(this._buffer instanceof Bb ? 5 : 4), this._publisher.middleware(function (a) {
                            c.send(a)
                        }))
                }
            }, "wv2.start"),
            ...
            send: function (a, b) {
                ...
                k.forEachKey(a, function (a, f) {
                    ...
                    if (d) {
                        ...
                        k.inArray(["event",
                            "articleInfo"
                        ], m) && (g = this._eventsBuffer);
                        d.iterate ? k.forEachKey(f, function (a, d) {
                            var f = "eof" === d.type && !d.frameId,
                                k = [g],
                                l;
                            f && (k = [this._eventsBuffer, this._buffer]);
                            for (l = 0; l < k.length; l++) this.executor.addAsyncItem(k[l].addData, k[l], f, [m, d, c, f, b], "send." + (d ? d.type || d.group || "" : "empty"))
                        }, this) : g.addData(m, f, c)
                    }
                }, this)
            },
            getVc: function () {
        ...
        Eb = {
            ...
            handle: function (a) {
                ...
                "init" == d ? (d = "yaCounter" + c, n[d] || (a = k.mixin(a[2] || {}, {
                    id: +c
                }), n[d] = new n.Ya[this.constructorName](a))) : k.inArray(this.counters, b) && f && f[d] ? (a = [].slice.call(a, 2), f[d].apply(f, a)) : k.inArray(this.counters, b) || (this.waitPool[b] || (this.waitPool[b] = []), this.waitPool[b].push(a));
                return 1
            },
    ...
    var fc = wa.inherit({
            ...
            request: function (a, b, c, d) {
                ...
                l.async = "async";
                var m = t.getElementsByTagName("head")[0];
                m || (m = t.createElement("head"), t.documentElement.appendChild(m));
                k.async(function () {
                    m.insertBefore(l,
                        m.firstChild)
                });
        ...
        pb = Pa.inherit({
            ...
            checkYandexHost: function (a) {
                if (a) {
                    a: {
                        if (a =
                            k.parseUrl(a).host.match(/(?:^|\.)(?:ya|yandex)\.(?:\w+|com?\.\w+)$/))
                            if (a = a[0].split("yandex").reverse()[0].substring(1), -1 != k.arrayIndexOf(xb, a)) break a;a = !1
                    }
            ...
            sendHit: function (a) {
                ...
                c && (this._ilStorage.remove("il"), b.ilt = na.encode(Oa.encode(k.trim(c, Gb))));
        ...
        Hb = K.inherit({
            ...
            hit: function (a, b) {
                ...
                !f && d && (f = this._cookie.read(this.KEY_NAME)) && (f = aa.parse(f));
                f && f.params && f.time + 864E5 > y.getMs() ? (c.globalConfig.set("isEU", f.params.eu), a(f)) : (this.globalConfig.set("fakeHit", function (a) {
                    l.push(a)
                    ...
                    callback: function (b, d) {
                        ...
                        c._cookie.create(c.KEY_NAME, aa.stringify(f), 1728);
                        a(f);
        ...
        Ib = K.inherit({
            ...
            _initComponent: function () {
                ...
                this.syncTlds = k.reduce(function (a, c) {
                    return c(a)
                }, xb, [k.bind(k.filter, null, function (b) {
                    return b !== a.baseTld
                ...
                k.forEachKey(this.partners, function (a, c) {
                    c.regex.test(n.location.hostname) && (this.syncTlds[c.tld] || (this.syncTlds[c.tld] = []), this.syncTlds[c.tld].push(a), this._replaceBase[a] = !0)
                }, this)
            },
            _replaceBase: {},
            langToDomain: {
            ...
            sync: function (a) {
                var b =
                    this,
                    c = this._need(),
                    d = -1 != I().hostname.search(/(?:^|\.)(?:ya|yandex(sport)?|beru|kinopoisk)\.(?:\w+|com?\.\w+)$/);
            ...
            _need: function () {
                ...
                c = k.arrayFilter(c, function (a) {
                    return (f[a] || 1) + 1440 < y.getMinutes()
                });
                return c.length && c || !1
            },
            _syncAdmetrica: function () {
                var a = new pa({}),
                    b = this._getLs();
                ((b.get("synced") || {}).SYNCED_ADM || 1) + 1440 < y.getMinutes() && a.request("https://mc.admetrica.ru/sync_cookie_image_check", {}, function (a) {
                    b.get("synced");
                    var c = y.getMinutes();
                    a || (c -= 1435);
                    a = b.get("synced") || {};
            ...
            _sync: function (a, b) {
                ...
                if (0 < f) {
                    ...
                    for (c = 0; c < f; c++)(function (a) {
                        n.request("https://" + (k._replaceBase[a] ? a : k.baseUrl + a) + "/sync_cookie_image_check", {}, function (b) {
                            g();
                            var c = y.getMinutes();
                            b || (c -= 1435);
                            b = m.get("synced") || {};
    ...
    var Qa = {
        ...
        hc = {
            sync: F(function (a, b, c, d) {
                ...
                if (this._enabled(a,
                    ...
                    (function q(a) {
                        var b = g[a];
                        a < m ? k.request(b[0] + ":" + b[1] + "/p", f, function (c, d) {
            ...
            _enabled: function (a, b, c) {
                if (!(60 < y.getMinutes() - Qa.getNum("ds")) || this._is() || k.isDev(this.globalConfig)) return !1;
                a = 0 === b && 0 <= k.arrayIndexOf([39370095, 1282253, 29302335, 43653484, 41734944, 31048081, 16443139, 27737346, 41870499,
                    33911514, 30744873, 5564395, 2580487
                ], a);
                a = va() || !c && .1 >= Math.random() && a;
                c = v.isIOS() && a;
        ...
        W = {
            ...
            getTarget: function (a) {
                var b = null;
                try {
                    if (b = a.target || a.srcElement) !b.ownerDocument && b.documentElement ? b = b.documentElement : b.ownerDocument !== t && (b =
                        null)
                } catch (c) {}
                return b
            },
            getMouseButton: function (a) {
                return a.which || a.button == x ? a.which : a.button & 1 ? 1 : a.button & 2 ? 3 : a.button & 4 ? 2 : 0
            },
            prevent: function (a) {
                a = a || n.event;
    ...
    W.dispatchCustomEvent = F(function (a, b) {
        var c;
        b = b || t;
        if (c = k.getNativeFunction("createEvent", t)("Event")) c.initEvent(a, !1, !1), k.getNativeFunction("dispatchEvent", b)(c)
    }, "evt.dispatch");
    var Xa = {
            lastReferrer: null
        },
        Ja = K.inherit({
            ...
            initUserLayer: function () {
                ...
                if (this.prefsEcommerce || this.prefsUseDataLayer) this._overridePush(this.prefsEcommerce) || (k.isString(this.prefsEcommerce) && (this.dataLayerName =
                    this.prefsEcommerce), a = this.dataLayerName, this._tryTimeout = k.bind(this._tryTimeout, this), this._tryTimeout()), this.counter._ecommerce = a
            },
            ...
            _tryTimeout: function () {
                this._overridePush(n[this.dataLayerName]) || (this.overrideTimeout = k.setTimeout(this._tryTimeout, 1E3, "dlObserver"))
            },
            _callHandlers: function (a) {
                k.arrayEvery(Ja.handlers,
                    function (b) {
                ...
                for (f = a.length; l < f; l++) {
                        ...
                        if ("params" === g.type && g.data) {
                            ...
                            if (g.counter) this.counter && this.counter.params && this.counterId ==
                                ...
                                k.forEachKey(this.globalConfig.get("counters"), function (b, c) {
                                    var d = b.split(":")[0];
                                    !k.inArray(a.sended, d) && c && c.params && (c.params(a.data), a.sended.push(d))
                                }, this)
                            }, this, k.mixin({}, g));
                            g.status == this.status.NEW && g.parent && this.frameConnector && this.frameConnector.checkFrame(n.parent) && n.parent !== n && (this.frameConnector.sendToParents({
                                    type: "params",
                                    data: g.data
                                },
                                function () {
                    ...
                    if (d && d.ecommerce) {
                        ...
                        k.forEachKey(d.ecommerce, function (a, b) {
                            0 <= k.arrayIndexOf(c, a) && (r = !0, m[a] = b)
                        });
                        r && b.push(m)
                    }
    ...
    Ja.handlers = [];
    var Jb = "GDPR-ok GDPR-cross GDPR-cancel GDPR-skip GDPR-frame-skip GDPR-frame-ya GDPR-frame-noya GDPR-open-start GDPR-eu-skip GDPR-open-fail GDPR-open-success GDPR-cookie-success GDPR-cookie-fail GDPR-skip-login GDPR-skip-domain GDPR-skip-na GDPR-skip-eu-na GDPR-skip-wv".split(" "),
        ic = ["https://brozen.yandex.ru", "https://yabro1.zen-test.yandex.ru/yabro/index.html", "https://yabro2.zen-test.yandex.ru/yabro/index.html"],
        xa = K.inherit({
            globalKey: "f1",
            MAX_SIZE: 1E6,
            isYAN: !1,
            ...
            enabled: va() && -1 < n.location.href.indexOf("yagdprcheck\x3d1"),
            _initComponent: function () {
            ...
            handle: function () {
                ...
                if (!this.enabled && ("0" === l || v.isSafariWebView() || v.isAndroidWebView() ||
                        k.inArray(ic, n.location.href.split("?")[0]) || !va() || f.read("yandex_login") || this.disable)) return f.read("yandex_login") ? this.trigger("GDPR-skip-login") : va() ? "0" === l ? this.trigger("GDPR-skip") : v.isSafariWebView() || v.isAndroidWebView() ? this.trigger("GDPR-skip-wv") : this.trigger("GDPR-skip-na") : this.trigger("GDPR-skip-domain"), this.realise(u, b);
                ...
                a.hit(function (a) {
                    if (a.params.eu || g || m.enabled)
                        if (m.frameConnector && m.frameConnector.addHandler("isYandex", function () {
                            ...
                            m.frameConnector.sendToParents({
                                ...
                                c[0].isYandex ? (m.trigger("GDPR-frame-ya"), m.frameConnector.addHandler("GDPR-ok", function () {
                                    d || (f.create("gdpr", "0", 525600), m.realise(c, b), d = !0)
                        ...
                        } else m.askGDPR(l, d, c, u, b, f);
                    else return a.params.eu ? m.trigger("GDPR-skip-eu-na") : m.trigger("GDPR-eu-skip"), m.realise(u, b)
                })
            }
        });
    xa.globalKey = "f1";
    ...
    xa.getState = function (a) {
        ...
        a = k.reduce(function (a, b) {
            b.ymetrikaEvent && k.inArray(Jb, b.ymetrikaEvent.type) && a.push(k.arrayIndexOf(Jb, b.ymetrikaEvent.type));
            return a
        }, [], a.get("dataLayer"));
        return a.length ?
    ...
    var jc = {
        init: function (a, b, c) {
            "22663942" == c && (c = t.createElement("img"), a && a.account && a.tmsec && b && (c.src = "https://www.tns-counter.ru/V13a****" + a.account + "/ru/UTF-8/tmsec\x3d" + a.tmsec + "/" + b))
        }
    };
    ...
    v.isPrivate = F(function (a) {
        var b =
            k.bind(a, null, 0);
        a = k.bind(a, null, 1);
        if (k.isFunction(n.webkitRequestFileSystem) && !v.isAndroid()) return n.webkitRequestFileSystem(0, 0, b, a);
        if (v.isFF()) return "undefined" == typeof navigator.serviceWorker;
        if (v.isSafari() && k.isFunction(n.openDatabase)) try {
    ...
    var kc = R.inherit({
        ...
        lc = K.inherit({
            ...
            start: function () {
                if (!this._start) z.on(t, "click", this._handler, this);
                this._start = !0
            },
            stop: function () {
                this._start && z.un(t, "click", this._handler, this);
                this._start = !1
            },
            setTrackHash: function (a) {
                this.isTrackHash = a
        ...
        Kb = K.inherit({
            ...
            getInjectHash: function () {
                ...
                k.forEachKey(this.injectHash, function (b) {
                    a[Fa + ("" + k.fnv32a(b))] = this.injectHash[b]
                }, this);
                return a
            },
            checkAssessor: function () {
                ...
                k.forEachKey(b, function (c) {
                    if ((new RegExp(c)).test(n.location.hash) || Q.get(this.ASSESSOR_COOKIE + c)) Q.set(this.ASSESSOR_COOKIE + c), a.push(b[c])
                }, this);
                return a
            },
            _initComponent: function () {
                ...
                this.globalConfig.get(this.REMOTE_CONTROL) || (this.globalConfig.set(this.REMOTE_CONTROL,
                    !0), Kb.superclass._initComponent.apply(this, arguments), this._executedMsgs = {}, z.on(n, "message", this._onMessage, this), a.length && (this.globalConfig.set("oo", !0), this.globalConfig.get("stopRecoder", function () {})(), k.arrayEvery(a, function (a) {
                    w.loadScript({
                        src: a
                    }, n);
                    return 1
            ...
            _buildRemoteIframe: function (a) {
                ...
                if (c) {
                    ...
                    n._ym__remoteIframeEl = d;
                    b.createShadowRoot || b.webkitCreateShadowRoot ? (c.appendChild(b), b.removeChild(d), (c = b.createShadowRoot ? b.createShadowRoot() : b.webkitCreateShadowRoot()) && c.appendChild(d), n._ym__remoteIframeContainer = b) : (c.appendChild(d), n._ym__remoteIframeContainer = d)
                }
            },
        ...
        mc = {
            match: function () {
                this.enabled() && z.ready(function () {
                    var a = k.getNativeFunction("createElement", t)("iframe");
                    a.onload = function () {
                        Qa.save("cm", y.getMinutes());
                        w.removeNode(a)
                    };
            ...
            enabled: function () {
                return 1440 < y.getMinutes() - Qa.getNum("cm") && "tr" === k.getTld()
            }
        };
    F(function () {
        (function (a) {
            ...
            4: function (a, b, c) {
                ...
                var d =
                    ...
                    r = t.documentElement;
                b.detectAd = function () {
                    var a = n.pageYOffset || r.scrollTop || m.scrollTop,
                        b = n.pageXOffset || r.scrollLeft || m.scrollLeft,
                        c = r.clientTop || m.clientTop || 0,
                        l = r.clientLeft || m.clientLeft || 0,
                        h = r.scrollWidth || r.offsetWidth || n.innerWidth,
                        e = r.scrollHeight || r.offsetHeight || n.innerHeight,
                        t = g.getFrienlyWindowsTree(n),
                        w = [];
                    ...
                    x.forEach(function (d) {
                        ...
                        var m = g + n,
                            ...
                            q = 0 > g ? 0 : g < h ? g : h,
                            r = 0 > k ? 0 : k < e ? k : e;
                        100 <= ((m > h ? h : m > q ? m : q) - q) * ((p > e ? e : p > r ? p : r) - r) && v.push({
                            top: k,
                            left: g,
                            width: n,
                            height: f,
            ...
            9: function (a, b, c) {
                ...
                b.getAdsInWindow = function (a, b) {
                    ...
                    var g = b.isInIFrame,
                        ...
                        n = d.listToArray(k.querySelectorAll("iframe")),
                        p = d.listToArray(k.querySelectorAll("script")),
                    ...
                    g && p.filter(function (a) {
                            return f.isGoogleSrc(a.src)
                        }).length &&
                        t.push("google");
                    c("awaps", n.filter(function (a) {
                        return (a = a.src) && -1 < a.indexOf("awaps.yandex.net/")
                    }));
                    c("criteo", n.filter(function (a) {
                        var b = a.src;
                        a = a.id;
    ...
    var nc = {
        ...
        Lb = K.inherit({
            ...
            _initComponent: function () {
                ...
                if (this.message) {
                    ...
                    z.on(n, "message", this.onMessage, this, {
                        passive: !1,
                        name: "FrameConnector"
                    })
                }
        ...
        Gb = 100,
        kb = "noindex",
        Mb = /\.(3gp|7z|aac|ac3|acs|ai|avi|ape|apk|asf|bmp|bz2|cab|cdr|crc32|css|csv|cue|divx|dmg|djvu?|doc(x|m|b)?|emf|eps|exe|flac?|flv|iso|swf|gif|t?gz|jpe?g?|js|m3u8?|m4a|mp(3|4|e?g?)|m4v|md5|mkv|mov|msi|ods|og(g|m|v)|psd|rar|rss|rtf|sea|sfv|sit|sha1|svg|tar|tif?f|torrent|ts|txt|vob|wave?|wma|wmv|wmf|webm|ppt(x|m|b)?|xls(x|m|b)?|pdf|phps|png|xpi|g?zip)$/i,
        oc = +new Date,
        oa = "Metrika",
        qb, bb, Fa = function () {
            return "1795"
        }();
    D.init().setSafe("counters", {}).setSafe("hitParam", {}).setSafe("counterNum", 0).setSafe("dataLayer", []).setSafe("hitId", k.random(1, 1073741824)).setSafe("_globalMetrikaHitId", k.random()).setSafe("v", Fa);
    Ea.globalConfig = D;
    oa = "Metrika2";
    n.Ya[oa] = function (a, b, c, d) {
        var f = this;
        return F(function () {
            function l(a) {
                var b = t.referrer || "",
                ...
                if (a && "string" != typeof a && a.length)
                    for (d = 0; d < a.length; d++) {
                        ...
                        if ("#" == g) {
                            ...
                            for (g = w.getElementsByClassName(e), e = 0; e <
                                g.length; e++) {
                                c = !0;
                                var h = g[e],
                                    k = f;
            ...
            function r(a, b) {
                ...
                d && (d = -1 < d.indexOf(";") ?
                    k.safeDecodeURIComponent(d) : Oa.decode(na.decode(d.replace(/[-*_]/g, function (a) {
                        return {
                            "*": "+",
                            "-": "/",
                            _: "\x3d"
            ...
            function q() {
                var q = !1,
                    u = !1;
                ra || (u = R.initCookie(va), yb.init(D));
                Ea.initPU(N, D);
                v.isAndroidWebView() || Ea.initPP(D);
                R.retransmit(D);
                wa && jc.init(wa, ca, a);
                D.get("pri") != x || v.isAndroidWebView() ||
                    (D.setSafe("pri", null), v.isPrivate(F(function (a) {
                        D.set("pri", a)
                    }, "privCb")));
                ha.init(ua);
                Eb.subscribe(Z);
                if (D.get("hitParam")[Z]) {
                    if (1 != c || D.get("counters")[Z]) return !1;
                    q = !0
                }
                D.get("counters")[Z] = f;
                D.get("hitParam")[Z] = 1;
                ...
                f._webvisor = M.webvisor || !1;
                f._directCampaign = M.directCampaign;
                M.trackHash && G(!0);
                if (!q) {
                    qa = new Db({
                        protocol: "https:",
                    ...
                    var y = function (e) {
                        ...
                        h.sendHit({
                            ...
                            callback: function (h, p) {
                                ...
                                h = h || {};
                                (q = "0" !== h.pcs) || Ea.initZZ();
                                h.eu !== x && D.set("isEU", h.eu);
                                Qa.init(p);
                                mc.match();
                                hc.sync(a, c, q, D);
                                d || S.log("PageView. Counter ", a, ". URL: ", L.href, ". Referrer: " + t.referrer, ". Params: ", b);
                                h.webvisor && (h.webvisor.isEU = D.get("isEU"));
                                if (!f.isDestructing()) {
                                    qa.start(h.webvisor, h.publisher);
                                    var u = h.mp2;
                                    q = new Q({
                                        counterId: a
                                    });
                                            ...
                                            if (U && U.length)
                                                for (ia = 0; ia < U.length; ia++) {
                                                    ...
                                                    if ("ref" == w.type) w = l(w);
                                                        ...
                                                        var v;
                                                        var y = w;
                                                        var A = n.Ya._metrika.counter._directCampaign;
                                                        var X = y.ServiceNamePattern;
                                                        var B = y.RefererPattern;
                                                        w = A ? y.direct_orders : y.direct_camp;
                                                        var C = t.referrer,
                                                            sa = Da.parse(L.search),
                                                            E = r(L.search, L.hash),
                                                            F = {};
                                                        var G = ["source", "medium", "campaign", "term", "content"];
                                                        for (v = 0; v < G.length; v++) sa["utm_" + G[v]] && (F[G[v]] = sa["utm_" + G[v]]);
                                                        var H = A ? "direct.yandex.ru" : E && E.service || F.source;
                                                        v = !1;
                                                        if (!v && X && X.length)
                                                            for (G = 0; G < X.length; G++)
                                                                if ((new RegExp(X[G], "i")).test(H)) {
                                                                    v = !0;
                                                                    break
                                                                } if (!v && !y.yandex_direct && B && B.length)
                                                            for (X = 0; X < B.length; X++)
                                                                if ((new RegExp(B[X], "i")).test(C)) {
                                                                    v = !0;
                                                                    break
                                                                }! v && y.google_adwords && sa.gclid && (v = !0);
                                                        if (v && w && w.length && (v = !1, A = A || E && E.campaign || F && F.campaign))
                                                    ...
                                                    if (w) {
                                                        U[ia].track_id && q.create("mp2_track", U[ia].track_id, 43200);
                                                        break b
                                                    }
                                                }
                                        }
                                        U = q.read("mp2_track");u = u.substs && u.substs[U];U && u ? (q.create("mp2_substs", k.toJSON(u)), q = g(u), f.params("__ym", q ? "mp_trackid" : "mp_trackid_bad", U)) : m()
                                    }
                                    else m();
                                    z.on(n, "load", f.replacePhones, f)
                                }
                                f._inited = !0;
                                e && e()
                            }
                ...
                0 != k.keys(M).length && (ta && ta.initUserLayer(), M.enableAll ? (p(!0), e(!0), E()) : (M.clickmap && e(M.clickmap), M.trackLinks && p(M.trackLinks), M.accurateTrackBounce && E(M.accurateTrackBounce)), M.triggerEvent && k.async(function () {
            ...
            function h(a) {
                if (f._trackLinks && f._trackLinks.on) {
                    ...
                    if (c && !w.classNameExists(a, "ym-disable-tracklink")) {
                        ...
                        var g = tb(a);
                        g = c === g ? "" : g;
                        if (w.classNameExists(a, "ym-external-link")) P.sendClickLink({
                            url: c,
                            title: g,
                            modes: d
                        }, O);
                        else {
                            var h = M.url ? k.parseUrl(O).hostname : I().hostname;
                            d.dl = Mb.test(e) || Mb.test(c) || ub(c, pa) || ub(e, pa);
                            b = b.hostname;
                            (h ? h.replace(/^www\./, "") : "").toLowerCase() == (b ? b.replace(/^www\./, "") : "").toLowerCase() ? d.dl ? (d.ln = !1, P.sendClickLink({
                                url: c,
                                title: g,
                                modes: d
                            }, O)) : (g = tb(a), V.set("pai", d.pai), g && g !== c && V.set("il", k.trim(g, Gb))) : c && -1 !== c.search(/^ *(data|javascript):/i) || (d.ut = kb, P.sendClickLink({
                                url: c,
                                title: g,
                                modes: d
                            }, O))
            ...
            function B(a, b) {
                ...
                function e(a) {
                    ...
                    for (b = 0; b < r.length; b += 3)
                        if (a) z.on(r[b], r[b + 1], r[b + 2], {
                            name: "tabTrack"
                        });
                        else z.un(r[b], r[b + 1], r[b + 2])
                }
                var f = !1,
                    g = !1,
                    h = !0,
                    ...
                    p = null,
                    q = !1;
                if (v.isIE()) k.setTimeout(a, b, "trackUserTime");
                else {
            ...
            function E(b) {
                ...
                if (!f._isAccurateTrackBounce) {
                    ...
                    var g = e.get("lastHit");
                    e.set("lastHit", y.getMs());
                    ((e = e.get("lastHit")) && (!g || g < e - 18E5) || !Qb(c, d) || .1 > Math.random()) && B(function () {
                        f.notBounce()
                    }, b)
                }
            }
            ...
            function A(a) {
                ...
                (function Ma() {
                    var d = b();
                    d !== c && (a(), c = d);
                    ya = k.setTimeout(Ma, 200, "trackHash")
                })()
            }

            function G(a) {
                if (!1 === a) Ca && ("onhashchange" in n ? z.un(n, "hashchange", J) : k.clearTimeout(ya), Ca = !1);
                else if (a = J,
                    !Ca) {
                    if ("onhashchange" in n) z.on(n, "hashchange", a);
                    else A(a);
                    Ca = !0
                }
                P.setTrackHash(Ca);
            ...
            if (!n["disableYaCounter" + a]) {
                ...
                c = c || 0;
                var Z = a + ":" + c;
                if (D.get("counters")[Z]) return S.log("Duplicate counter " + Z + " initialization"), D.get("counters")[Z];
                var ca = D.get("hitId");
                var N = new Lb({
                    counterId: a,
                    hid: ca
                ...
                var ha = {
                    init: function (a, b) {
                        if (n.performance && "function" === typeof performance.getEntries && (a === x && (a = 1), !(Math.random() >= a))) {
                            var c = {
                                    1882689622: 1,
                                    2318205080: 1,
                                    3115871109: 1,
                            ...
                            k.keys(h).length && (new Ra(g)).logParams(h)
                        }
                    }
                };
                ua = 24226447 == a ? 1 : .002;
                f.replacePhones = u(function () {
                    ...
                    try {
                        (b = (new Q({
                            counterId: a
                        })).read("mp2_substs")) && (c = aa.parse(b)) && g(c, !0)
                    } catch (X) {}
                    return f
                }, "counter.replacePhones");
                f.reachGoal = u(function (b, c, d, e) {
                    2 <= arguments.length && "function" === typeof c && (e = d, d = c, c = x);
                ...
                f.hit = u(function (b, c, d, e, g, h) {
                    (b = b && k.isFunction(b.toString) ? b.toString() : !1) ? (k.isObject(c) && (d = c.referer, e = c.params, g = c.callback, h = c.ctx, c = c.title), O = b, S.log("PageView. Counter " + a, ". URL: " + b, ". Referrer: " + d, ". Params: ", e), P.sendHit({
                        url: b,
                        title: c,
                        hasPrerender: za,
                        referrer: d,
                ...
                f.params = u(function (b) {
                    ...
                    if (b) {
                        ...
                        (d = -1 !== k.arrayIndexOf(k.keys(e[0]), "__ym") && e[0].__ym.user_id) ? S.log('Set user id "' + e[0].__ym.user_id + '"'): S.log((c ? "User p" :
                            "P") + "arams. Counter " + a + ". Params: ", e[0]);
                        P.sendParams(e[0], g, h, M.url ? O : I().href)
                    } else k.warning("Wrong params");
                    return f
                }, "counter.params");
                N.addHandler("pluginInfo", function () {
                    return M
                }, this);
                N.addHandler("parentConnect", function (a, b) {
                    P.paramsQueue.push({
                        __ym: {
                            parentIframe: {
                                counterId: b.counterId,
                ...
                var Fa = {
                    ...
                    parseValidate: function (a, b) {
                        ...
                        for (d in b) b.hasOwnProperty(d) && -1 === k.arrayIndexOf(this.requiredEcommerceFields,
                            d) && (c[a].actionField || (c[a].actionField = {}), c[a].actionField[d] = b[d]);
                        return {
                            __ym: {
                                ecommerce: [c]
                            }
                ...
                f.id = f.setUserID = u(function (a, b, c) {
                    k.isString(a) || k.isNumber(a) ? f.params({
                        __ym: {
                            user_id: a
                        }
                ...
                f.destruct = u(function () {
                    ...
                    z.un(n, "load", f.replacePhones, f);
                    G(!1);
                    qa && qa.stop();
                    D.set("stopRecoder", x);
                    D.set("counter", x);
                    ta && ta.destruct && ta.destruct();
                    e(!1);
                    try {
                        delete n["yaCounter" + a], delete D.get("counters")[Z], delete D.get("hitParam")[Z]
                    } catch (U) {}
                });
                ...
                if (a) {
                    var ta = new Ja({
                        ...
                        globalConfig: D,
                        frameConnector: N,
                        prefsEcommerce: M.ecommerce,
                        prefsUseDataLayer: M.useDataLayer
                    });
                    if ("prerender" === t.webkitVisibilityState || "prerender" === t.visibilityState) {
                        ...
                        var ma = function () {
                            "prerender" !== t.webkitVisibilityState && "prerender" !== t.visibilityState && (z.un(t, "webkitvisibilitychange,visibilitychange", ma), C(!0))
                        };
                        z.on(t, "webkitvisibilitychange,visibilitychange", ma)
                    } else C(!1)
                }
            }
        }, "init")()
    ...
    n.Ya[oa].informer = function (a) {
        var b = !!n.Ya[oa]._informer;
        Ya[oa]._informer = a;
