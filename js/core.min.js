...
(function () {
    ! function (a, b, c) {
        var d, e, f;
        return e = navigator.appVersion.indexOf("MSIE") !== -1, f = "ontouchstart" in c, d = function () {
            function d(d, e) {
                this.options = a.extend(!0, {}, this.Defaults, e), this.element = d, this.$element = a(d), this.state = 0, this.$win = a(c), this.$doc = a(b), this.classes = {
                    ...
                    closeButton: "rd-audio-control-close"
                }, this.initialize()
            }
            return d.prototype.Defaults = {
                ...
                var a;
                a = this, this.createDataApi(), this.createAudio(), this.createProgressBar(), this.createVolumeBar(), this.updateState(a), this.attachPlayerEvents(), this.attachPlayPauseButtonListener(), this.attachVolumeButtonListener(), this.attachStopButtonListener(), this.initPlaylistClickListener(), this.triggerPlaylistClick(), this.attachNextTrackButtonListener(), this.attachPrevTrackButtonListener(), this.attachClosePlaylistListener(), this.updateDuration(), this.updateAuthorName(), this.updateTitle()
            }, d.prototype.createAudio = function () {
                var a;
                a = this, a.audio = new Audio, this.$element.append(a.audio), 0 === a.options.playListName.length && (a.loadTrack(a.options.src), a.getOption("autoplay") && a.audio.play())
            }, d.prototype.updateState = function (a) {
                var b;
                b = a.isErrored() ? 0 : a.isLoading() ? 1 : 2, a.state !== b && (a.state = b)
            }, d.prototype.attachPlayPauseButtonListener = function () {
                var a;
                a = this, a.$element.find("." + a.classes.playPause).on("click", function (b) {
                    var c;
                    b.preventDefault(), 2 === a.state && null == a.playListName && (a.isPlaying() ? a.audio.pause() : a.audio.play()), c = [a.playListName, a.index], a.$doc.trigger("playlistClick", c)
                })
            }, d.prototype.attachStopButtonListener = function () {
                var a;
                a = this, a.$element.find("." + a.classes.stopButton).on("click", function (b) {
                    var c;
                    b.preventDefault(), a.audio.currentTime = 0, c = [a.playListName, a.index, !1], a.$doc.trigger("playlistClick", c)
                })
            }, d.prototype.updateDuration = function () {
                var a, b;
                a = this, b = a.$element.find("." + a.classes.duration)[0], b && a.audio.addEventListener("durationchange", function () {
                    var c, d, e, f;
                    return c = a.getDuration(), f = ("0" + Math.floor(c) % 60).slice(-2), e = ("0" + Math.floor(c / 60 % 60)).slice(-2), d = c <= 3600 ? "" : ("0" + Math.floor(c / 3600 % 60) + ":").slice(-2), b.innerHTML = "" + d + e + ":" + f
                })
            }, d.prototype.updateAuthorName = function () {
                var a, b;
                b = this, a = b.$element.find("." + b.classes.author)[0], a && b.audio.addEventListener("durationchange", function () {
                    var c, d;
                    return b.playListName ? (c = b.$doc.find('[data-rd-audio-playlist="' + b.playListName + '"] li[data-index="' + b.index + '"]'), d = c[0].getAttribute("data-rd-audio-author")) : d = b.options.author, a.innerHTML = d
                })
            }, d.prototype.updateTitle = function () {
                var a, b;
                a = this, b = a.$element.find("." + a.classes.title)[0], b && a.audio.addEventListener("durationchange", function () {
                    var c, d;
                    return a.playListName ? (c = a.$doc.find('[data-rd-audio-playlist="' + a.playListName + '"] li[data-index="' + a.index + '"]'), d = c[0].getAttribute("data-rd-audio-title")) : d = a.options.title, b.innerHTML = d
                })
            }, d.prototype.updateCurrentTime = function (a) {
                var b, c, d, e, f;
                b = this, c = b.audio.currentTime, f = ("0" + Math.floor(c) % 60).slice(-2), e = ("0" + Math.floor(c / 60 % 60)).slice(-2), d = c <= 3600 ? "" : ("0" + Math.floor(c / 3600 % 60) + ":").slice(-2), a.innerHTML = "" + d + e + ":" + f
            }, d.prototype.attachVolumeButtonListener = function () {
                var a;
                a = this, a.$element.find("." + a.classes.volume).on("click", function (b) {
                    b.preventDefault(), a.audio.muted = !a.isMuted()
                })
            }, d.prototype.attachNextTrackButtonListener = function () {
                var a;
                a = this, a.$element.find("." + a.classes.nextButton).on("click", function (b) {
                    var c;
                    b.preventDefault(), c = a.$doc.find('[data-rd-audio-playlist="' + a.playListName + '"] li[data-index="' + (parseInt(a.index) + 1) + '"]').length ? [a.playListName, parseInt(a.index) + 1] : [a.playListName, 0], a.$doc.trigger("playlistClick", c)
                })
            }, d.prototype.attachPrevTrackButtonListener = function () {
                var a;
                a = this, a.$element.find("." + a.classes.prevButton).on("click", function (b) {
                    var c, d;
                    b.preventDefault(), parseInt(a.index) - 1 >= 0 ? c = [a.playListName, parseInt(a.index) - 1] : (d = a.$doc.find('[data-rd-audio-playlist="' + a.playListName + '"]'), c = [a.playListName, d.eq(d.length - 1).find("li").last().attr("data-index")]), a.$doc.trigger("playlistClick", c)
                })
            }, d.prototype.attachClosePlaylistListener = function () {
                var b;
                b = this, b.$element.find("." + b.classes.closeButton).on("click", function (c) {
                    var e = (b.$doc.find("[data-rd-audio-playlist]"), a(b.$doc.find('[data-rd-audio-playlist="' + b.playListName + '"] li.playing')[0]));
                    c.preventDefault(), e && (b.clearPlayListClasses(), b.playlistPlayPause(e, !1)), b.element.classList.contains("rd-audio-playlist-visible") && b.element.classList.remove("rd-audio-playlist-visible"), b.element.classList.add("rd-audio-playlist-hidden")
                })
            }, d.prototype.removeStateClass = function (a) {
                var b, c, d, e;
                for (c = a.element.className.split(/\s+/), d = 0, e = c.length; d < e; d++) b = c[d], b.indexOf("state-") !== -1 && a.element.classList.remove(b)
            }, d.prototype.createProgressBar = function () {
                var c, d, e, g;
                e = this, e.$element.find("." + e.classes.progressBar).length && (e.currentProgress = g = b.createElement("div"), g.classList.add("current"), e.attachProgressBarSlider(), c = e.$element.find("." + e.classes.progressBar)[0], d = !1, a(c).on("mousedown.rd touchstart.rd", function (a) {
                    (1 === a.which || f) && (d = !0, e.audio.currentTime = e.getClickBarPosition(a, c, "horizontal") * e.getDuration(), e.$doc.on("mouseup.rd touchend.rd touchcancel.rd", function (a) {
                        if (d) return d = !1
                    }), e.$doc.on("mousemove.rd touchmove.rd", function (a) {
                        d && (e.audio.currentTime = e.getClickBarPosition(a, c, "horizontal") * e.getDuration())
                    }))
                }), c.appendChild(g))
            }, d.prototype.attachProgressBarSlider = function () {
                var a;
                a = this, a.$element.find("." + a.classes.progressBarSlider).length && (a.progressSlider = a.$element.find("." + a.classes.progressBarSlider)[0]), a.audio.addEventListener("seeked", function () {
                    return a.progressSlider.style.left = a.audio.currentTime / a.getDuration() * 100 + "%"
                })
            }, d.prototype.createVolumeBar = function () {
                var c, d, e, g;
                e = this, e.$element.find("." + e.classes.volumeBar).length && (e.currentVolume = g = b.createElement("div"), g.classList.add("current"), g.style.width = 100 * e.audio.volume + "%", e.attachVolumeBarSlider(), c = e.$element.find("." + e.classes.volumeBar)[0], e.getOption("volumeBarType") && c.classList.add("rd-audio-volume-bar-" + e.getOption("volumeBarType")), d = !1, a(c).on("mousedown.rd touchstart.rd", function (a) {
                    (1 === a.which || f) && (d = !0, e.audio.volume = e.getClickBarPosition(a, c, e.getOption("volumeBarType")), e.isMuted() && (e.audio.muted = !1), e.$doc.on("mouseup.rd touchend.rd touchcancel.rd", function (a) {
                        if (d) return d = !1
                    }), e.$doc.on("mousemove.rd touchmove.rd", function (a) {
                        d && (1 === a.which || f) && (e.audio.volume = e.getClickBarPosition(a, c, e.getOption("volumeBarType")), e.isMuted() && (e.audio.muted = !1))
                    }))
                }), c.appendChild(g))
            }, d.prototype.attachVolumeBarSlider = function () {
                var a;
                a = this, a.$element.find("." + a.classes.volumeBarSlider).length && (a.volumeBarSlider = a.$element.find("." + a.classes.volumeBarSlider)[0]), a.audio.addEventListener("volumechange", function () {
                    return "horizontal" === a.getOption("volumeBarType") ? a.isMuted() ? a.volumeBarSlider.style.left = "0" : a.volumeBarSlider.style.left = 100 * a.audio.volume + "%" : "vertical" === a.getOption("volumeBarType") ? a.isMuted() ? a.volumeBarSlider.style.bottom = "0" : a.volumeBarSlider.style.bottom = 100 * a.audio.volume + "%" : void 0
                })
            }, d.prototype.playlistPlayPause = function (a, b) {
                var c;
                c = this, null != b && b ? (c.audio.play(), a.addClass("playing"), c.element.classList.contains("rd-audio-playlist-hidden") && c.element.classList.remove("rd-audio-playlist-hidden"), c.element.classList.add("rd-audio-playlist-visible")) : b === !1 ? (c.audio.pause(), a.addClass("paused")) : c.isPlaying() ? (c.audio.pause(), a.addClass("paused")) : (c.audio.play(), a.addClass("playing"), c.element.classList.contains("rd-audio-playlist-hidden") && c.element.classList.remove("rd-audio-playlist-hidden"), c.element.classList.add("rd-audio-playlist-visible"))
            }, d.prototype.initPlaylistClickListener = function () {
                var a;
                a = this, a.$element.find("." + a.classes.playlist).length && (a.playlist = a.$element.find("." + a.classes.playlist)[0]), null == a.index && (a.index = -1), a.$doc.on("playlistClick", function (b, c, d, e) {
                    var f;
                    a.clearPlayListClasses(), f = a.$doc.find('[data-rd-audio-playlist="' + c + '"] li[data-index="' + d + '"]'), f.length && (null != a.playListName && a.playListName === c ? null != a.index && a.index === d ? null == e || e ? a.playlistPlayPause(f) : a.playlistPlayPause(f, !1) : (a.loadTrack(f[0].getAttribute("data-rd-audio-src")), a.playlistPlayPause(f, !0), a.index = d) : (a.playListName = c, a.index = d, a.loadTrack(f[0].getAttribute("data-rd-audio-src")), null == e || e ? (a.addToPlaylist(a, c, d, !0), a.playlistPlayPause(f, !0)) : (a.addToPlaylist(a, c, d, !1), a.playlistPlayPause(f, !1))))
                })
            }, d.prototype.triggerPlaylistClick = function () {
                var c, d, e, f, g, h;
                for (c = this, h = c.$doc.find("[data-rd-audio-playlist]"), c.setPlaylistIndexes(h), d = 0, e = h.length; d < e; d++) f = h[d], a(f).find(f.getAttribute("data-rd-audio-play-on")).on("click", function (c) {
                    var d, e, f;
                    return d = a(this), "A" === this.tagName && c.preventDefault(), e = d.parents("[data-index]").length ? d.parents("[data-index]").attr("data-index") : this.getAttribute("data-index"), f = [d.parents("[data-rd-audio-playlist]").attr("data-rd-audio-playlist"), parseInt(e)], a(b).trigger("playlistClick", f)
                });
                null != c.playlist && c.$doc.delegate("." + c.classes.playlist + " li", "click", function () {
                    var a, b;
                    return a = parseInt(this.getAttribute("data-index")), b = [c.playListName, a], c.$doc.trigger("playlistClick", b)
                }), c.options.playListName && (c.index = 0, g = [c.options.playListName, 0, c.getOption("autoplay")], c.$doc.trigger("playlistClick", g))
            }, d.prototype.loadTrack = function (a) {
                var b;
                b = this, b.audio.src = a, b.audio.load()
            }, d.prototype.clearPlayListClasses = function () {
                var a;
                a = this, a.$doc.find("[data-rd-audio-playlist] .paused").removeClass("paused"), a.$doc.find("[data-rd-audio-playlist] .playing").removeClass("playing")
            }, d.prototype.setPlaylistIndexes = function (b) {
                var c, d, e, f, g, h;
                for (g = [], c = [], e = 0, f = b.length; e < f; e++) h = b[e], g.indexOf(h.getAttribute("data-rd-audio-playlist")) === -1 ? (d = g.length, g.push(h.getAttribute("data-rd-audio-playlist")), c.push(0)) : d = g.indexOf(h.getAttribute("data-rd-audio-playlist")), a(h).find("li").each(function () {
                    return this.setAttribute("data-index", c[d]), c[d] += 1
                })
            }, d.prototype.getTrackDurations = function () {
                var b, c, d, e;
                b = this, d = 0, e = b.$element.find('[data-rd-audio-playlist="' + b.playListName + '"]'), c = e.find("li").eq(d), b.audioDurations.src = c.attr("data-rd-audio-src"), b.audioDurations.load(), null != b.audioDurations && b.audioDurations.addEventListener("loadedmetadata", function () {
                    var f, g, h, i;
                    return d++, f = this.duration, i = ("0" + Math.floor(f) % 60).slice(-2), h = ("0" + Math.floor(f / 60 % 60)).slice(-2), g = f <= 3600 ? "" : ("0" + Math.floor(f / 3600 % 60) + ":").slice(-2), c.innerHTML = "", c.append("<span class='song-duration'>" + g + h + ":" + i + "</span>"), e.find("li").eq(d).length ? (c = e.find("li").eq(d), b.audioDurations.src = c.attr("data-rd-audio-src"), b.audioDurations.load()) : a(b.audioDurations).remove()
                })
            }, d.prototype.addToPlaylist = function (b, c, d, e) {
                var f;
                b = this, null != b.playlist && (b.audio.pause(), null == b.audioDurations && (b.audioDurations = new Audio, this.$element.append(b.audioDurations)), f = "", b.$doc.find('[data-rd-audio-playlist="' + c + '"]').each(function () {
                    return a(this).find("li").each(function () {
                        var a;
                        return a = "", parseInt(this.getAttribute("data-index")) === d && (a = null == e || e ? "playing" : "paused"), f += '<li class="' + a + '" data-rd-audio-src="' + this.getAttribute("data-rd-audio-src") + '"data-index="' + this.getAttribute("data-index") + '" ', this.getAttribute("data-rd-audio-author") && (f += 'data-rd-audio-author="' + this.getAttribute("data-rd-audio-author") + '" '), this.getAttribute("data-rd-audio-title") && (f += 'data-rd-audio-title="' + this.getAttribute("data-rd-audio-title") + '"'), f += ">", this.getAttribute("data-rd-audio-author") && (f += '<span class="song-author">' + this.getAttribute("data-rd-audio-author") + "</span> - "), this.getAttribute("data-rd-audio-title") && (f += '<span class="song-title">' + this.getAttribute("data-rd-audio-title") + "</span>"), f += "</li>"
                    })
                }), b.playlist.setAttribute("data-rd-audio-playlist", c), b.playlist.innerHTML = f, b.getTrackDurations())
            }, d.prototype.attachPlayerEvents = function () {
                var a, b, c;
                b = this, a = b.audio, c = b.$element.find("." + b.classes.currentTime), a.addEventListener("canplay", function () {
                    if (b.element.classList.remove("state-loading"), c.length && b.updateCurrentTime(c[0]), null != b.volumeBarSlider) {
                    ...
                    return b.removeStateClass(b), b.element.classList.add("state-playing")
                }), a.addEventListener("playing", function () {
                    return b.removeStateClass(b), b.element.classList.add("state-playing")
                }), a.addEventListener("pause", function () {
                    return b.removeStateClass(b), b.element.classList.add("state-pause")
                }), a.addEventListener("ended", function () {
                    var a;
                    return b.options.loop ? (b.audio.currentTime = 0, b.audio.play()) : null != b.playlist ? (a = b.$doc.find('[data-rd-audio-playlist="' + b.playListName + '"] li[data-index="' + (parseInt(b.index) + 1) + '"]').length ? [b.playListName, parseInt(b.index) + 1] : [b.playListName, 0], b.$doc.trigger("playlistClick", a)) : void 0
                    ...
                    } else if (b.element.classList.remove("muted"), null != b.currentVolume) {
                    ...
                    var d;
                    if (null != b.currentProgress && (d = a.currentTime / b.getDuration() * 100 + "%", b.currentProgress.style.width = d), null != b.progressSlider && (b.progressSlider.style.left = d), c.length) return b.updateCurrentTime(c[0])
                ...
                var d, e, g, h, i, j;
                return a.preventDefault(), "horizontal" === c ? (g = b.getBoundingClientRect().left, h = b.clientWidth, a.originalEvent && (a = a.originalEvent), i = f ? a.targetTouches[0].clientX : a.clientX, Math.min(1, Math.max(0, (i - g) / h))) : "vertical" === c ? (d = b.getBoundingClientRect().bottom, e = b.clientHeight, a.originalEvent && (a = a.originalEvent), j = f ? a.targetTouches[0].clientY : a.clientY, Math.min(1, Math.max(0, (d - j) / e))) : void 0
                ...
                return !(!this.state && this.isEmpty()) && (this.audio.networkState === this.audio.NETWORK_LOADING && this.audio.readyState < this.audio.HAVE_FUTURE_DATA)
                ...
                var a;
                a = this, this.$element.attr("data-rd-audio-src") && (a.options.src = this.$element.attr("data-rd-audio-src")), this.$element.attr("data-rd-volume-bar-type") && (a.options.volumeBarType = this.$element.attr("data-rd-volume-bar-type")), this.$element.attr("data-rd-audio-playlist-name") && (a.options.playListName = this.$element.attr("data-rd-audio-playlist-name")), this.$element.attr("data-rd-audio-author") && (a.options.author = this.$element.attr("data-rd-audio-author")), this.$element.attr("data-rd-audio-title") && (a.options.title = this.$element.attr("data-rd-audio-title")), this.$element.attr("data-rd-audio-autoplay") && (a.options.autoplay = "true" === this.$element.attr("data-rd-audio-autoplay")), this.$element.attr("data-rd-audio-loop") && (a.options.loop = "true" === this.$element.attr("data-rd-audio-loop"))
            }, d.prototype.getOption = function (a) {
                var b, d;
                for (b in this.options.responsive) b <= c.innerWidth && (d = b);
                return null != this.options.responsive && null != this.options.responsive[d][a] ? this.options.responsive[d][a] : this.options[a]
            }, d
        }(), a.fn.extend({
            RDAudio: function (b) {
                return this.each(function () {
                    var c;
                    if (c = a(this), !c.data("RDAudio")) return c.data("RDAudio", new d(this, b))
                })
            }
        }), c.RDAudio = d
    }(window.jQuery, document, window), "undefined" != typeof module && null !== module ? module.exports = window.RDAudio : "function" == typeof define && define.amd && define(["jquery"], function () {
        "use strict";
