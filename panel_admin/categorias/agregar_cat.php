...
<head>
    ...
    <link rel="stylesheet" href="../../estilos/nueva_cat.css">
...
<div id="container">
    ...
    <div class="dif"></div>
    <form action="guardar_cat.php" enctype="multipart/form-data" method="POST" id="">
        ...
        <select name="marca" id="marca" class="custom-select my-1 mr-sm-2">
                    ...
                    $query = "SELECT nombre_categoria_forzz as categoria, id_categoria_forzz as id FROM categoria_forzz ORDER BY nombre_categoria_forzz";
