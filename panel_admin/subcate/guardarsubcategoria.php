...
//numero sin formato
    ...
    $sqlsx = "INSERT INTO sub_categoria_forzz (nombre_sub_forzz, id_cat_forzz) VALUES (? ,?);";
   
    $stmt2 = mysqli_prepare($con_admin,$sqlsx);
    // var_dump($stmt2);
    $stmt2->bind_param("ss",$nombretipo, $idcat);
    $stmt2->execute();
    
     
    if (!$stmt2) {
   $mensaje ='ERROR AL INGRESAR LA SUB CATEGORIA';
...
header( "refresh:3;url=form_oferta.php" );
    ...
    exit;
        ...
        $mensaje = "SUB CATEGORIA INGRESADA";
    ...
    echo $elemento;
    header( "refresh:3;url=agregarsubcate.php" );
    }
