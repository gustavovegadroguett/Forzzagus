...
<div id="content">
    ...
    <div id="menu" class="nav">
        ...
        <ul>
            ...
            <li><a href="../tipoproducto/agregar_tipo_pro.php"><i class="fas fa-cubes"></i>&nbsp;&nbsp;Tipo de Productos</a></li>
            <br>
            ...
            <li><a href="./agregarsubcate.php"><i class="fas fa-file-upload"></i>&nbsp;&nbsp;Nueva Sub Categoría</a></li>
