...
$sql ="SELECT * FROM tipo_producto WHERE id_subca = ?";
?>
...
<?php  include 'menu_db.php';?>
    <div class="container-portada-tipo_pro">
        <div class="capa-gradiente">

        </div>
        <div class="container-detalle">
            <div class="detalle">
                <h1>Productos Forzza</h1>
    ...
    <main class="main-contenido-lista">
        ...
        <div class="titulo">
            <h2 class="subtitulo">Nuestros Productos Disponibles</h2>
        </div>
        <hr>

        <div class="contenido-calugas-tipo_pro">
           ...
           ?>
                        ...
                        <div class="service_item-sub">
                            <div class="service_item_inner">
                                ...
                                <br>
                                <a href="#">
                                    <h4><?php echo $row['nombre_tipo_producto'];  ?></h4>
                                </a>
                                <br>
                                
                                <a class="view_btn" href="lista_pro.php?x=<?php echo $row['id_tipo_pro'];?>&c=<?php echo $row['nombre_tipo_producto'];?>">Conocer Más</a>
                            </div>
                        </div>
