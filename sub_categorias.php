...
$sql ="SELECT * from sub_categoria_forzz WHERE id_cat_forzz = ?";
?>
...
<?php  include 'menu_db.php';?>
    <div class="container-portada-subcategoria">
        <div class="capa-gradiente">

        </div>
        <div class="container-detalle">
            <div class="detalle">
                <h1>SubCategorias Forzza</h1>
    ...
    <main class="main-contenido-lista">
        ...
        <div class="titulo">
            <h2 class="subtitulo">Nuestras SubCategorías Disponibles</h2>
        </div>
        <hr>
           ...
           ?>
                        ...
                        <div class="service_item-sub">
                            <div class="service_item_inner">
                                ...
                                <br>
                                <a href="#">
                                    <h4><?php echo $row['nombre_sub_forzz'];  ?></h4>
                                </a>
                                <br>
                                
                                <a class="view_btn" href="tipo_producto.php?x=<?php echo $row['id_sub_forzz'];?>&c=<?php echo $row['nombre_tipo_producto'];?>">Conocer Más</a>
                            </div>
                        </div>
