...
echo '<script language="javascript">alert(mostrando ip inicio pagina"'.$ip_add.'");</script>';
include "conexiones/conexion.php";
if(isset($_POST["category"])){
	$category_query = "SELECT * FROM categoria_forzz";
	
	$run_query = mysqli_query($conexion,$category_query) or die(mysqli_error($conexion));
	echo "
...
if (isset($_POST["count_item"])) {
	...
	$row = mysqli_fetch_array($query);
	echo '<script language="javascript">alert( row se sup"'.$id_add.'");</script>';	
	echo $row["count_item"];
	exit();
}
//Count User cart item
...
if (isset($_POST["Common"])) {
	...
	if (isset($_SESSION["uid"])) {
		...
		$sql = "SELECT a.sku_producto_id,a.nombre_prod_forzz,a.precio_prod_forzz,a.id_img_forzz,b.id,b.qty FROM productos_forzz a,cart b WHERE a.sku_producto_id=b.p_id AND b.user_id='$_SESSION[uid]'";
	}else{
